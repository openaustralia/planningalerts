...
h3. Setting up a dev environment !https://secure.travis-ci.org/openaustralia/planningalerts-app.png?branch=master(Build Status)!:http://travis-ci.org/openaustralia/planningalerts-app
