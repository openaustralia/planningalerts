...
if (isset($_GET['year'])){
	...
	//search url
	$search_url = "http://planning.lambeth.gov.uk/publicaccess/dc/DcApplication/application_searchresults.aspx?searchtype=WEEKLY&selWeeklyListRange=#daterange&weektype=VAL";
	...
	$info_url_base = "http://planning.lambeth.gov.uk/publicaccess/dc/DcApplication/application_detailview.aspx?caseno=";
	$comment_url_base = "http://planning.lambeth.gov.uk/publicaccess/dc/DcApplication/application_comments_entryform.aspx?caseno=";
