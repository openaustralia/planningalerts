...
if (isset($_GET['year'])){
	...
	$info_url_base = "http://publicaccess.salford.gov.uk/publicaccess/dc/DcApplication/application_detailview.aspx?caseno=";
	$comment_url_base = "http://publicaccess.salford.gov.uk/publicaccess/dc/DcApplication/application_comments_entryform.aspx?caseno=";
