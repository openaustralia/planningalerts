...
describe CommentsHelper do
  describe "#donation_declaration_notice" do
    it { expect(helper.donation_declaration_notice).to eq "Have you made a donation or gift to a Councillor or Council employee? #{link_to("You may need to disclose this", faq_path(:anchor => "disclosure"))}." }
