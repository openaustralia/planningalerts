...
feature "Councillor replies to a message sent to them" do
  ...
  given(:application) { create_geocoded_application(id: 8, address: "24 Bruce Road Glenbrook", description: "A lovely house") }
  given!(:comment) do
    create(:comment, id: 5,
...
feature "Commenter is notified of the councillors reply" do
  ...
  given(:application) do
    create_geocoded_application(id: 8, address: "24 Bruce Road Glenbrook", description: "A lovely house")
  end
