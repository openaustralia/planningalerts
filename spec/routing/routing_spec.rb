...
describe "api routing" do
  ...
  it {expect(get: "applications.js?bottom_left_lat=1&bottom_left_lng=2&top_right_lat=3&top_right_lng=4").to route_to(
    controller: "api", action: "area", format: "js")}
