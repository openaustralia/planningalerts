...
# This is an autogenerated file for dynamic methods in `AlertsNewController`.
# Please instead update this file by running `bin/tapioca dsl AlertsNewController`.

class AlertsNewController
