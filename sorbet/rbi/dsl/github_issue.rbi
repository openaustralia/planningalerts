  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::GithubIssue).void)
      ).returns(T.nilable(T::Enumerator[::GithubIssue]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::GithubIssue]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::GithubIssue]]))
    end
