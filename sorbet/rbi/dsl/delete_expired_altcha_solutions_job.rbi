...
# This is an autogenerated file for dynamic methods in `DeleteExpiredAltchaSolutionsJob`.
# Please instead update this file by running `bin/tapioca dsl DeleteExpiredAltchaSolutionsJob`.
