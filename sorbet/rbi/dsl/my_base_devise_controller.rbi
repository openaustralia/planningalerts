...
# This is an autogenerated file for dynamic methods in `MyBaseDeviseController`.
# Please instead update this file by running `bin/tapioca dsl MyBaseDeviseController`.

class MyBaseDeviseController
