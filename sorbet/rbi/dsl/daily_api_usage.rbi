...
class DailyApiUsage
  ...
  module CommonRelationMethods
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::DailyApiUsage)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::DailyApiUsage) }
    def find_signed!(signed_id, purpose: nil); end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::DailyApiUsage).returns(T.type_parameter(:U))
