...
# This is an autogenerated file for dynamic methods in `QueueUpImportApplicationsJob`.
# Please instead update this file by running `bin/tapioca dsl QueueUpImportApplicationsJob`.
