...
class Role::HABTM_Users
  ...
  module CommonRelationMethods
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Role::HABTM_Users).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Role::HABTM_Users])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::Role::HABTM_Users).void
      ).returns(T.nilable(::Role::HABTM_Users))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::Role::HABTM_Users])
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Role::HABTM_Users]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Role::HABTM_Users]])
    end
    ...
    sig { params(limit: NilClass).returns(T.nilable(::Role::HABTM_Users)) }
    sig { params(limit: Integer).returns(T::Array[::Role::HABTM_Users]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Role::HABTM_Users).returns(T.type_parameter(:U))
