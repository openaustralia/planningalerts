...
class HTTP::Client
  # source://http/4.4.1/lib/http/client.rb#21
  def initialize(default_options = T.unsafe(nil)); end

  # source://http/4.4.1/lib/http/client.rb#66
  def __perform__(req, options); end

  # source://http/4.4.1/lib/http/client.rb#40
  def build_request(verb, uri, opts = T.unsafe(nil)); end

  # source://http/4.4.1/lib/http/client.rb#101
  def close; end
  ...
  # source://http/4.4.1/lib/http/client.rb#28
  ...
  # source://http/4.4.1/lib/http/client.rb#182
  def make_form_data(form); end

  # source://http/4.4.1/lib/http/client.rb#167
  def make_request_body(opts, headers); end

  # source://http/4.4.1/lib/http/client.rb#150
  def make_request_headers(opts); end

  # source://http/4.4.1/lib/http/client.rb#128
  def make_request_uri(uri, opts); end

  # source://http/4.4.1/lib/http/client.rb#110
  def verify_connection!(uri); end
end

# source://http/4.4.1/lib/http/client.rb#19
...
class HTTP::Request
  # source://http/4.4.1/lib/http/request.rb#83
  def initialize(opts); end

  # source://http/4.4.1/lib/http/request.rb#74
  def body; end

  # source://http/4.4.1/lib/http/request.rb#147
  def connect_using_proxy(socket); end

  # source://http/4.4.1/lib/http/request.rb#152
  def headline; end

  # source://forwardable/1.3.1/forwardable.rb#226
  def host(*args, &block); end

  # source://http/4.4.1/lib/http/request.rb#137
  def include_proxy_authorization_header; end

  # source://http/4.4.1/lib/http/request.rb#131
  def include_proxy_headers; end

  # source://http/4.4.1/lib/http/request.rb#198
  def inspect; end

  # source://http/4.4.1/lib/http/request.rb#74
  def proxy; end

  # source://http/4.4.1/lib/http/request.rb#141
  def proxy_authorization_header; end

  # source://http/4.4.1/lib/http/request.rb#164
  def proxy_connect_header; end

  # source://http/4.4.1/lib/http/request.rb#169
  def proxy_connect_headers; end

  # source://http/4.4.1/lib/http/request.rb#100
  def redirect(uri, verb = T.unsafe(nil)); end

  # source://http/4.4.1/lib/http/request.rb#67
  def scheme; end

  # source://http/4.4.1/lib/http/request.rb#181
  def socket_host; end

  # source://http/4.4.1/lib/http/request.rb#186
  def socket_port; end

  # source://http/4.4.1/lib/http/request.rb#116
  def stream(socket); end

  # source://http/4.4.1/lib/http/request.rb#73
  def uri; end

  # source://http/4.4.1/lib/http/request.rb#69
  def uri_normalizer; end

  # source://http/4.4.1/lib/http/request.rb#127
  def using_authenticated_proxy?; end

  # source://http/4.4.1/lib/http/request.rb#122
  def using_proxy?; end

  # source://http/4.4.1/lib/http/request.rb#64
  def verb; end
  ...
  # source://http/4.4.1/lib/http/request.rb#215
  def default_host_header_value; end

  # source://http/4.4.1/lib/http/request.rb#210
  def port; end

  # source://http/4.4.1/lib/http/request.rb#219
  def prepare_body(body); end

  # source://http/4.4.1/lib/http/request.rb#223
  def prepare_headers(headers); end
end

# source://http/4.4.1/lib/http/request.rb#29
HTTP::Request::METHODS = T.let(T.unsafe(nil), Array)

# source://http/4.4.1/lib/http/request.rb#56
HTTP::Request::PORTS = T.let(T.unsafe(nil), Hash)

# source://http/4.4.1/lib/http/request.rb#53
HTTP::Request::SCHEMES = T.let(T.unsafe(nil), Array)

# source://http/4.4.1/lib/http/request.rb#27
...
class HTTP::Response
  # source://http/4.4.1/lib/http/response.rb#45
  def initialize(opts); end

  # source://http/4.4.1/lib/http/response.rb#27
  def body; end

  # source://forwardable/1.3.1/forwardable.rb#226
  def charset(*args, &block); end

  # source://http/4.4.1/lib/http/response.rb#142
  def chunked?; end
  ...
  # source://http/4.4.1/lib/http/response.rb#103
  def content_length; end

  # source://http/4.4.1/lib/http/response.rb#122
  def content_type; end

  # source://http/4.4.1/lib/http/response.rb#136
  def cookies; end

  # source://http/4.4.1/lib/http/response.rb#93
  def flush; end

  # source://http/4.4.1/lib/http/response.rb#162
  def inspect; end

  # source://forwardable/1.3.1/forwardable.rb#226
  def mime_type(*args, &block); end

  # source://http/4.4.1/lib/http/response.rb#157
  def parse(as = T.unsafe(nil)); end

  # source://http/4.4.1/lib/http/response.rb#33
  ...
  # source://http/4.4.1/lib/http/response.rb#21
  def status; end

  # source://http/4.4.1/lib/http/response.rb#86
  def to_a; end
  ...
  # source://http/4.4.1/lib/http/response.rb#30
  def uri; end

  # source://http/4.4.1/lib/http/response.rb#24
  def version; end
