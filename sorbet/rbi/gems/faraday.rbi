...
class Faraday::RequestOptions < Anonymous_Faraday_Options_73
  def []=(key, value); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_74
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_75 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_75
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_76
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_77 < Faraday::Options
  def method; end
  def method=(_); end
  def parallel_manager; end
  def parallel_manager=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_77
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_78
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
...
class Faraday::Request::Retry::Options < Anonymous_Faraday_Options_79
  def backoff_factor; end
  def exceptions; end
  def interval; end
  def interval_randomness; end
