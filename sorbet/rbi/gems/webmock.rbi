...
class HTTP::Response::Streamer
  ...
  def readpartial(size = nil, outbuf = nil); end
  def sequence_id; end
end
...
class WebMock::HttpLibAdapters::TyphoeusAdapter < WebMock::HttpLibAdapter
  def self.add_after_request_callback; end
  def self.add_before_callback; end
  def self.build_request_signature(req); end
  def self.build_webmock_response(typhoeus_response); end
  def self.disable!; end
  def self.disabled?; end
  def self.enable!; end
  def self.generate_typhoeus_response(request_signature, webmock_response); end
  def self.remove_after_request_callback; end
  def self.remove_before_callback; end
  def self.request_hash(request_signature); end
end
