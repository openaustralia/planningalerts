...
class Mail::Address
  ...
  # source://actionmailbox/7.0.8.4/lib/action_mailbox/mail_ext/address_equality.rb#5
  ...
  class << self
    # source://actionmailbox/7.0.8.4/lib/action_mailbox/mail_ext/address_wrapping.rb#5
