...
class Honeybadger::Agent
  ...
  # @return self
  #
  # source://honeybadger//lib/honeybadger/agent.rb#310
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#284
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#193
  def check_in(id); end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#368
  def config; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#260
  ...
  #   data is flushed).
  #
  # source://honeybadger//lib/honeybadger/agent.rb#351
  def flush; end
  ...
  # @return [Hash, nil]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#278
  def get_context; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#362
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#212
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#431
  def with_rack_env(rack_env, &block); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#439
  def worker; end

  private

  # source://honeybadger//lib/honeybadger/agent.rb#461
  def context_manager; end

  # source://honeybadger//lib/honeybadger/agent.rb#476
  def init_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#466
  def push(object); end

  # source://honeybadger//lib/honeybadger/agent.rb#471
  def send_now(object); end

  # @raise [ArgumentError]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#453
  def validate_notify_opts!(opts); end

  # source://honeybadger//lib/honeybadger/agent.rb#480
...
class Honeybadger::Config
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#283
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#349
  def build_file_logger(path); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#360
  def build_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#340
  def build_stdout_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#307
  def config_path; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#311
  def config_paths; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#317
  def default_backend; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#296
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#381
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#375
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#403
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#334
Honeybadger::Config::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://honeybadger//lib/honeybadger/config/defaults.rb#36
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#38
