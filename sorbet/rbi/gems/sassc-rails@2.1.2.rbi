...
class Sprockets::SassCompressor
  ...
  # source://sprockets/3.7.3/lib/sprockets/sass_compressor.rb#35
  def cache_key; end
  ...
  class << self
    # source://sprockets/3.7.3/lib/sprockets/sass_compressor.rb#31
    def cache_key; end

    # source://sprockets/3.7.3/lib/sprockets/sass_compressor.rb#27
    def call(input); end

    # source://sprockets/3.7.3/lib/sprockets/sass_compressor.rb#23
    def instance; end
  end
end
