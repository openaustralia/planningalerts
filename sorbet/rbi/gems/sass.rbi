...
module Sass::Util
  def absolute_path(path, dir_string = nil); end
  ...
  def scope(file); end
  def self.absolute_path(path, dir_string = nil); end
  ...
  def self.enum_cons(enum, n); end
  def self.enum_slice(enum, n); end
  def self.enum_with_index(enum); end
  def self.escape_uri(string); end
  ...
  def self.ord(c); end
  def self.ordered_hash(*pairs_or_hash); end
  ...
  def self.ruby1?; end
  def self.ruby1_8?; end
  def self.ruby1_9_2?; end
...
class Sass::Source::Map::Mapping < Anonymous_Struct_44
  def inspect; end
end
module Sass::Tree
end
...
class Sass::Tree::PropNode < Sass::Tree::Node
  ...
  def self.invalid_parent_method_name; end
  def self.node_name; end
  def self.val_to_sass(value, opts); end
  def self.val_to_sass_comma(node, opts); end
  def self.val_to_sass_concat(node, opts); end
  def self.val_to_sass_div(node, opts); end
  def self.visit_method; end
  def tabs; end
  def tabs=(arg0); end
  def value; end
...
module Sass::Script::Functions
  ...
  def join(list1, list2, separator = nil); end
...
class Sass::Script::Parser
  ...
  def interpolation(first = nil); end
  ...
  def or_expr; end
  def paren; end
  def parse(css_variable = nil); end
...
class Sass::Script::Tree::Node
  ...
  def css_variable_warning=(arg0); end
...
class Sass::SCSS::Parser
  ...
  def interp_ident(start = nil); end
  ...
  def throw_error; end
  def tok!(rx); end
  def tok(rx, last_group_lookahead = nil); end
  def tok?(rx); end
  def try_declaration; end
  def use_css_import?; end
  def value!(css_variable = nil); end
  def var_expr; end
  def variable; end
...
class Sass::SCSS::StaticParser < Sass::SCSS::Parser
  ...
  def interp_ident(ident = nil); end
  def interp_string; end
  def interp_uri; end
  def interpolation(warn_for_color = nil); end
...
class Sass::Engine::Line < Anonymous_Struct_45
  def comment?; end
end
...
module Sass::Plugin
  ...
  def checked_for_updates=(arg0); end
  def compiler; end
  def force_update_stylesheets(individual_files = nil); end
  def method_missing(method, *args, &block); end
  def options; end
  def respond_to?(method); end
  def update_stylesheets(individual_files = nil); end
  extend Sass::Plugin
end
module Sass::Plugin::Configuration
  def add_template_location(template_location, css_location = nil); end
  def convert_template_location(template_location, css_location); end
  def default_options; end
  def normalize_template_location!; end
  def options; end
  def remove_template_location(template_location, css_location = nil); end
  def reset!; end
...
class Sass::Plugin::StalenessChecker
  ...
  def self.dependencies_cache; end
  def self.dependencies_cache=(arg0); end
  def self.dependency_cache_mutex; end
  def self.stylesheet_modified_since?(template_file, mtime, importer = nil); end
  def self.stylesheet_needs_update?(css_file, template_file, importer = nil); end
  def stylesheet_modified_since?(template_file, mtime, importer = nil); end
  def stylesheet_needs_update?(css_file, template_file, importer = nil); end
  def tree(uri, importer); end
  def with_dependency_cache; end
end
class Sass::Plugin::Compiler
  def child_of_directory?(parent, child); end
  def clean(individual_files = nil); end
  def create_listener(*args, &block); end
  def css_filename(name, path); end
  def css_locations; end
  def engine_options(additional_options = nil); end
  def file_list(individual_files = nil); end
  def initialize(opts = nil); end
  def listen_to(listener); end
  def load_paths(opts = nil); end
  ...
  def update_stylesheets(individual_files = nil); end
  def watch(individual_files = nil, options = nil); end
