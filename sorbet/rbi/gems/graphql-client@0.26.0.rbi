...
module GraphQL
  class << self
    # source://graphql/2.6.3/lib/graphql.rb#39
    def default_parser; end

    # source://graphql/2.6.3/lib/graphql.rb#43
    def default_parser=(_arg0); end

    # source://graphql/2.6.3/lib/graphql.rb#14
    def eager_load!; end

    # source://graphql/2.6.3/lib/graphql.rb#49
    def parse(graphql_string, trace: T.unsafe(nil), filename: T.unsafe(nil), max_tokens: T.unsafe(nil)); end

    # source://graphql/2.6.3/lib/graphql.rb#56
    def parse_file(filename); end

    # source://graphql/2.6.3/lib/graphql.rb#66
    def parse_with_racc(string, filename: T.unsafe(nil), trace: T.unsafe(nil)); end

    # source://graphql/2.6.3/lib/graphql.rb#84
    def reject_numbers_followed_by_names; end

    # source://graphql/2.6.3/lib/graphql.rb#84
    def reject_numbers_followed_by_names=(_arg0); end

    # source://graphql/2.6.3/lib/graphql.rb#62
    def scan(graphql_string); end

    # source://graphql/2.6.3/lib/graphql.rb#71
