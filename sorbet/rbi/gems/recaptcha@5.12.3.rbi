...
module Recaptcha::Helpers
  class << self
    # source://recaptcha//lib/recaptcha/helpers.rb#90
    def invisible_recaptcha_tags(custom); end

    # source://recaptcha//lib/recaptcha/helpers.rb#301
    def recaptcha_execute_method_name; end

    # source://recaptcha//lib/recaptcha/helpers.rb#305
    def recaptcha_ready_method_name; end

    # source://recaptcha//lib/recaptcha/helpers.rb#47
    ...
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#263
    def recaptcha_v3_async_execute_function_name(action); end

    # source://recaptcha//lib/recaptcha/helpers.rb#267
    ...
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#258
    def recaptcha_v3_execute_function_name(action); end

    # source://recaptcha//lib/recaptcha/helpers.rb#109
    def to_error_message(key); end

    # source://recaptcha//lib/recaptcha/helpers.rb#115
    def to_message(key, default); end

    private

    # source://recaptcha//lib/recaptcha/helpers.rb#124
    ...
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#324
    def dasherize_action(action); end

    # v2
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#273
    def default_callback(options = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#309
    def default_callback_required?(options); end

    # source://recaptcha//lib/recaptcha/helpers.rb#328
    def hash_to_query(hash); end

    # source://recaptcha//lib/recaptcha/helpers.rb#238
    ...
    # @return [Boolean]
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#250
    ...
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#180
    def recaptcha_v3_inline_script(site_key, action, callback, id, options = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#232
    def recaptcha_v3_inline_script?(options); end

    # source://recaptcha//lib/recaptcha/helpers.rb#214
    ...
    #
    # source://recaptcha//lib/recaptcha/helpers.rb#318
