...
class Net::IMAP < ::Net::Protocol
  ...
  # @raise [ArgumentError]
  #
  # source://net-imap//lib/net/imap.rb#967
  ...
  # own authenticator.
  #
  # source://net-imap//lib/net/imap.rb#412
  ...
  # using it.
  #
  # source://net-imap//lib/net/imap.rb#321
  def capability; end
  ...
  #
  # source://net-imap//lib/net/imap.rb#255
  ...
  #
  # source://net-imap//lib/net/imap.rb#479
  def delete(mailbox); end

  # Disconnects from the server.
  #
  # source://net-imap//lib/net/imap.rb#284
  def disconnect; end
  ...
  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap.rb#307
  ...
  #
  # source://net-imap//lib/net/imap.rb#459
  ...
  #
  # source://net-imap//lib/net/imap.rb#654
  ...
  # The QUOTA extension is described in [EXT-QUOTA[https://tools.ietf.org/html/rfc2087]]
  #
  # source://net-imap//lib/net/imap.rb#638
  def getquotaroot(mailbox); end

  # Returns an initial greeting response from the server.
  #
  # source://net-imap//lib/net/imap.rb#232
  def greeting; end
  ...
  #
  # source://net-imap//lib/net/imap.rb#345
  ...
  #
  # source://net-imap//lib/net/imap.rb#1016
  def idle(timeout = T.unsafe(nil), &response_handler); end

  # Leaves IDLE.
  #
  # source://net-imap//lib/net/imap.rb#1046
  def idle_done; end

  # Seconds to wait until an IDLE response is received.
  #
  # source://net-imap//lib/net/imap.rb#252
  ...
  #
  # source://net-imap//lib/net/imap.rb#536
  ...
  # A Net::IMAP::NoResponseError is raised if authentication fails.
  #
  # source://net-imap//lib/net/imap.rb#430
  def login(user, password); end

  # Sends a LOGOUT command to inform the server that the client is
  # done with the connection.
  #
  # source://net-imap//lib/net/imap.rb#359
  def logout; end
  ...
  #
  # source://net-imap//lib/net/imap.rb#707
  ...
  #
  # source://net-imap//lib/net/imap.rb#924
  ...
  #
  # source://net-imap//lib/net/imap.rb#593
  def namespace; end
  ...
  #
  # source://net-imap//lib/net/imap.rb#249
  def open_timeout; end

  # Removes the response handler.
  #
  # source://net-imap//lib/net/imap.rb#973
  ...
  #
  # source://net-imap//lib/net/imap.rb#490
  def rename(mailbox, newname); end

  # Returns all response handlers.
  #
  # source://net-imap//lib/net/imap.rb#244
  ...
  #   #=> 968263756
  #
  # source://net-imap//lib/net/imap.rb#241
  def responses; end
  ...
  #   #=> [1, 6, 7, 8]
  #
  # source://net-imap//lib/net/imap.rb#829
  ...
  #
  # source://net-imap//lib/net/imap.rb#446
  ...
  # The ACL extension is described in [EXT-ACL[https://tools.ietf.org/html/rfc4314]]
  #
  # source://net-imap//lib/net/imap.rb#681
  ...
  # The QUOTA extension is described in [EXT-QUOTA[https://tools.ietf.org/html/rfc2087]]
  #
  # source://net-imap//lib/net/imap.rb#667
  ...
  #
  # source://net-imap//lib/net/imap.rb#944
  ...
  # does not exist.
  #
  # source://net-imap//lib/net/imap.rb#730
  ...
  #
  # source://net-imap//lib/net/imap.rb#500
  ...
  #
  # source://net-imap//lib/net/imap.rb#914
  ...
  # The SORT extension is described in [EXT-SORT-THREAD[https://tools.ietf.org/html/rfc5256]].
  #
  # source://net-imap//lib/net/imap.rb#951
  def uid_sort(sort_keys, search_keys, charset); end

  # Similar to #store, but +set+ contains unique identifiers.
  #
  # source://net-imap//lib/net/imap.rb#901
  ...
  # subscribed to it.
  #
  # source://net-imap//lib/net/imap.rb#510
  ...
  #        #<Net::IMAP::MailboxList attr=[:Noinferiors], delim="/", name="foo/baz">]
  #
  # source://net-imap//lib/net/imap.rb#625
  ...
  # source://net-imap//lib/net/imap/command_data.rb#86
  def send_number_data(num); end

  # source://net-imap//lib/net/imap/command_data.rb#65
  def send_quoted_string(str); end

  # source://net-imap//lib/net/imap/command_data.rb#50
  ...
  # source://net-imap//lib/net/imap/command_data.rb#106
  ...
  class << self
    ...
    #
    # source://net-imap//lib/net/imap/data_encoding.rb#16
    def decode_utf7(s); end

    # The default port for IMAP connections, port 143
    #
    # source://net-imap//lib/net/imap.rb#268
    def default_imap_port; end

    # The default port for IMAPS connections, port 993
    #
    # source://net-imap//lib/net/imap.rb#273
    ...
    #
    # source://net-imap//lib/net/imap/data_encoding.rb#27
    def encode_utf7(s); end

    # Formats +time+ as an IMAP-style date.
    #
    # source://net-imap//lib/net/imap/data_encoding.rb#39
    def format_date(time); end

    # Formats +time+ as an IMAP-style date-time.
    #
    # source://net-imap//lib/net/imap/data_encoding.rb#44
...
#
# source://net-imap//lib/net/imap/flags.rb#193
...
class Net::IMAP::BodyTypeAttachment < ::Struct
  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap/response_data.rb#473
  def multipart?; end
end
...
class Net::IMAP::BodyTypeBasic < ::Struct
  ...
  #
  # source://net-imap//lib/net/imap/response_data.rb#396
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap/response_data.rb#389
  def multipart?; end
end
...
class Net::IMAP::BodyTypeExtension < ::Struct
  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap/response_data.rb#521
  def multipart?; end
end
...
class Net::IMAP::BodyTypeMessage < ::Struct
  ...
  # the value of +subtype+.
  #
  # source://net-imap//lib/net/imap/response_data.rb#452
  def media_subtype; end
...
class Net::IMAP::BodyTypeMultipart < ::Struct
  ...
  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap/response_data.rb#505
  def multipart?; end
end
...
class Net::IMAP::BodyTypeText < ::Struct
  ...
  # the value of +subtype+.
  #
  # source://net-imap//lib/net/imap/response_data.rb#423
  def media_subtype; end

  # @return [Boolean]
  #
  # source://net-imap//lib/net/imap/response_data.rb#416
  def multipart?; end
end
...
class Net::IMAP::ClientID
  ...
  #
  # source://net-imap//lib/net/imap/command_data.rb#246
  def initialize(data); end
...
#
# source://net-imap//lib/net/imap/flags.rb#207
...
#
# source://net-imap//lib/net/imap/flags.rb#127
...
#
# source://net-imap//lib/net/imap/flags.rb#140
...
#
# source://net-imap//lib/net/imap/flags.rb#96
...
module Net::IMAP::NumValidator
  ...
  #
  # source://net-imap//lib/net/imap/data_encoding.rb#96
  ...
  #
  # source://net-imap//lib/net/imap/data_encoding.rb#88
  def ensure_nz_number(num); end

  # Check is passed argument valid 'mod_sequence_value' in RFC 4551 terminology
  #
  # source://net-imap//lib/net/imap/data_encoding.rb#71
  def valid_mod_sequence_value?(num); end

  # Check is passed argument valid 'number' in RFC 3501 terminology
  #
  # source://net-imap//lib/net/imap/data_encoding.rb#53
  def valid_number?(num); end

  # Check is passed argument valid 'nz_number' in RFC 3501 terminology
  #
  # source://net-imap//lib/net/imap/data_encoding.rb#62
...
#
# source://net-imap//lib/net/imap/flags.rb#165
...
class Net::IMAP::ResponseParser
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#16
  def parse(str); end
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#1178
  def address; end
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#307
  def body_data; end

  # source://net-imap//lib/net/imap/response_parser.rb#513
  def body_ext_1part; end

  # source://net-imap//lib/net/imap/response_parser.rb#549
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#585
  def body_fld_dsp; end

  # source://net-imap//lib/net/imap/response_parser.rb#599
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#446
  def body_type_mpart; end

  # source://net-imap//lib/net/imap/response_parser.rb#391
  def body_type_msg; end

  # source://net-imap//lib/net/imap/response_parser.rb#377
  def body_type_text; end

  # source://net-imap//lib/net/imap/response_parser.rb#967
  def capability_data; end

  # source://net-imap//lib/net/imap/response_parser.rb#960
  def capability_response; end

  # source://net-imap//lib/net/imap/response_parser.rb#1259
  ...
  # charset = atom / quoted
  #
  # source://net-imap//lib/net/imap/response_parser.rb#1306
  def charset; end

  # source://net-imap//lib/net/imap/response_parser.rb#1135
  def charset_list; end

  # source://net-imap//lib/net/imap/response_parser.rb#1291
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#1209
  def flag_list; end

  # source://net-imap//lib/net/imap/response_parser.rb#273
  def flags_data; end

  # source://net-imap//lib/net/imap/response_parser.rb#736
  def flags_response; end

  # source://net-imap//lib/net/imap/response_parser.rb#689
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#280
  def internaldate_data; end

  # source://net-imap//lib/net/imap/response_parser.rb#743
  def list_response; end

  # source://net-imap//lib/net/imap/response_parser.rb#1383
  def lookahead; end

  # source://net-imap//lib/net/imap/response_parser.rb#750
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#712
  def modseq_data; end

  # source://net-imap//lib/net/imap/response_parser.rb#193
  def msg_att(n); end

  # source://net-imap//lib/net/imap/response_parser.rb#1046
  def namespace; end
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#1224
  def nstring; end
  ...
  #
  # source://net-imap//lib/net/imap/response_parser.rb#1082
  def resp_text; end
  ...
  # source://net-imap//lib/net/imap/response_parser.rb#300
  def rfc822_size; end
  ...
  #
  # source://net-imap//lib/net/imap/response_parser.rb#1077
  def text; end

  # source://net-imap//lib/net/imap/response_parser.rb#729
  def text_response; end

  # source://net-imap//lib/net/imap/response_parser.rb#898
...
# resp-specials   = "]"
#
# source://net-imap//lib/net/imap/response_parser.rb#1285
Net::IMAP::ResponseParser::ASTRING_CHARS_TOKENS = T.let(T.unsafe(nil), Array)

# source://net-imap//lib/net/imap/response_parser.rb#1329
...
#
# source://net-imap//lib/net/imap/flags.rb#221
...
module Net::IMAP::StringFormatter
  ...
  #
  # source://net-imap//lib/net/imap/command_data.rb#281
...
# source://net-imap//lib/net/imap/command_data.rb#271
...
#
# source://net-imap//lib/net/imap/flags.rb#231
