...
module ApplicationHelper
  def contributor_profile_url(contributor); end
  def contributors; end
  def facebook_share_url(params); end
  def km_in_words(value_in_km); end
  def li_selected(options, &block); end
  def meters_in_words(meters); end
  def nav_item(url, &block); end
  def our_sanitize(html); end
  def page_matches?(options); end
  def significant_figure(value, sig_figs); end
  def significant_figure_remove_trailing_zero(value, sig_figs); end
  def twitter_share_url(params); end
end
...
module AlertMailerHelper
  def application_url_with_tracking(id: nil); end
  def base_tracking_params; end
  def capitalise_initial_character(text); end
  def comment_url_with_tracking(comment: nil); end
  def new_comment_url_with_tracking(id: nil); end
  def new_donation_url_with_tracking(alert); end
  def reply_url_with_tracking(reply: nil); end
  def subject(alert, applications, comments, replies); end
end
module ApiHowtoHelper
  def api_example_address_url(format, key, address = nil, radius = nil); end
  def api_example_address_url_html(format, key); end
  def api_example_area_url(format, key, bottom_left_lat = nil, bottom_left_lng = nil, top_right_lat = nil, top_right_lng = nil); end
  def api_example_area_url_html(format, key); end
  def api_example_authority_url(format, key, authority = nil); end
  def api_example_authority_url_html(format, key); end
  def api_example_latlong_url(format, key, lat = nil, lng = nil, radius = nil); end
  def api_example_latlong_url_html(format, key); end
  def api_example_postcode_url(format, key, postcode = nil, extra_params = nil); end
  def api_example_postcode_url_html(format, key); end
  def api_example_suburb_state_and_postcode_url(format, key, suburb = nil, state = nil, postcode = nil); end
  def api_example_suburb_state_and_postcode_url_html(format, key); end
  def api_key(*args, &block); end
  def htmlify(url); end
end
module ApplicationsHelper
  def api_host; end
  def authority_applications_json_url_for_current_user(authority); end
  def days_ago_in_words(date); end
  def days_in_future_in_words(date); end
  def display_description_with_address(application); end
  def distance_and_heading_in_words(from, to); end
  def google_signed_url(domain:, path:, query:, key: nil); end
  def google_static_map(application, size: nil, zoom: nil, key: nil); end
  def google_static_map_lat_lng(lat, lng, size: nil, label: nil, zoom: nil, key: nil); end
  def google_static_map_url(application, zoom: nil, size: nil, key: nil); end
  def google_static_map_url_lat_lng(lat, lng, zoom: nil, size: nil, key: nil); end
  def google_static_streetview(application, size: nil, fov: nil, key: nil); end
  def google_static_streetview_url(application, size: nil, fov: nil, key: nil); end
  def heading_in_words(degrees); end
  def non_symmetric_round(value); end
  def on_notice_text(application); end
  def page_title(application); end
  def scraped_and_received_text(application); end
  def sign_gmap_bus_api_url(url_to_sign, google_cryptographic_key); end
end
module AtdisHelper
  def attribute_value(value); end
end
module AuthoritiesHelper
  def github_issues_url(authority); end
  def github_url(authority); end
  def morph_url(authority); end
  def morph_watchers_url(authority); end
end
module CommentsHelper
  def comment_as_html(text); end
  def comment_path(comment); end
  def comment_url(comment); end
  include ApplicationHelper
end
module CouncillorContributionsHelper
  def link_to_or_website_text_for(authority); end
end
module DonationsHelper
  def price_in_cents(price); end
end
module RepliesHelper
  def reply_path(reply); end
end
module SignupHelper
  def draw_box_javascript(size, alert, zone_sizes); end
end
module StaticHelper
end
module DeviseHelper
...
module Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_42
end
class ActiveAdmin::Comment < ActiveRecord::Base
  ...
  include Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_42
