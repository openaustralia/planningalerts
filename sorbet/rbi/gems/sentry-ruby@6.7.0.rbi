...
module Sentry
  class << self
    # source://sentry-ruby//lib/sentry-ruby.rb#254
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#350
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#511
    ...
    # @yieldparam scope [Scope]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#405
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#635
    ...
    # @return [String, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#608
    def get_baggage; end
    ...
    # @return [Client, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#371
    ...
    # @return [Hub]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#360
    ...
    # @return [Scope, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#379
    ...
    # @return [Hash, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#617
    ...
    # @return [String]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#626
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#265
    def init(&block); end
    ...
    # source://sentry-ruby//lib/sentry-ruby.rb#227
...
class Sentry::Backtrace
  ...
  #
  # source://sentry-ruby//lib/sentry/backtrace.rb#73
  def initialize(lines); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace.rb#89
  def ==(other); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace.rb#77
  def inspect; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace.rb#81
  def to_s; end
  ...
  class << self
    ...
    #
    # source://sentry-ruby//lib/sentry/backtrace.rb#15
...
class Sentry::Backtrace::Line
  ...
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#77
  def initialize(file, number, method, module_name, in_app_pattern); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#97
  def ==(other); end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#21
  def file; end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#85
  def in_app; end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#32
  def in_app_pattern; end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#101
  def inspect; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#27
  def method; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#30
  def module_name; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#24
  def number; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/backtrace/line.rb#93
  def to_s; end
  ...
  class << self
    ...
    #
    # source://sentry-ruby//lib/sentry/backtrace/line.rb#65
    ...
    #
    # source://sentry-ruby//lib/sentry/backtrace/line.rb#37
...
# @api private
#
# source://sentry-ruby//lib/sentry/backtrace/line.rb#9
...
# @api private
#
# source://sentry-ruby//lib/sentry/backtrace/line.rb#18
...
# @api private
#
# source://sentry-ruby//lib/sentry/backtrace/line.rb#11
...
class Sentry::DSN
  ...
  #
  # source://sentry-ruby//lib/sentry/dsn.rb#18
  ...
  # source://sentry-ruby//lib/sentry/dsn.rb#93
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/dsn.rb#69
  def localhost?; end
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/dsn.rb#73
  def private_ip?; end
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/dsn.rb#83
  ...
  # source://sentry-ruby//lib/sentry/dsn.rb#47
  def server; end
  ...
  # source://sentry-ruby//lib/sentry/dsn.rb#110
...
# source://sentry-ruby//lib/sentry/dsn.rb#13
...
class Sentry::DummyTransport < ::Sentry::Transport
  ...
  #
  # source://sentry-ruby//lib/sentry/transport/dummy_transport.rb#24
  def clear; end
...
class Sentry::Envelope::Item
  # source://sentry-ruby//lib/sentry/envelope/item.rb#35
  def initialize(headers, payload); end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#43
  ...
  # source://sentry-ruby//lib/sentry/envelope/item.rb#47
  def item_count; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#51
  def lost_event_byte_size; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#13
  def payload; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#61
  def serialize; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#77
  def size_breakdown; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#13
  def size_limit; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#57
  def to_s; end
  ...
  # source://sentry-ruby//lib/sentry/envelope/item.rb#93
  def reduce_stacktrace!; end

  # source://sentry-ruby//lib/sentry/envelope/item.rb#85
...
# source://sentry-ruby//lib/sentry/utils/filename_cache.rb#4
class Sentry::FilenameCache
  # @return [FilenameCache] a new instance of FilenameCache
  #
  # source://sentry-ruby//lib/sentry/utils/filename_cache.rb#7
  def initialize(project_root); end

  # Returns the value of attribute cache.
  #
  # source://sentry-ruby//lib/sentry/utils/filename_cache.rb#5
  def cache; end

  # source://sentry-ruby//lib/sentry/utils/filename_cache.rb#13
  def compute_filename(abs_path, in_app, strip_backtrace_load_path); end

  private

  # source://sentry-ruby//lib/sentry/utils/filename_cache.rb#43
...
class Sentry::HTTPTransport < ::Sentry::Transport
  ...
  # source://sentry-ruby//lib/sentry/transport/http_transport.rb#81
  def conn; end

  # source://sentry-ruby//lib/sentry/transport/http_transport.rb#106
  def do_request(endpoint, headers, body); end

  # source://sentry-ruby//lib/sentry/transport/http_transport.rb#73
  def endpoint; end

  # source://sentry-ruby//lib/sentry/transport/http_transport.rb#77
...
class Sentry::Hub
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#292
  def add_breadcrumb(breadcrumb, hint: T.unsafe(nil)); end

  # source://sentry-ruby//lib/sentry/hub.rb#81
  def bind_client(client); end

  # source://sentry-ruby//lib/sentry/hub.rb#202
  def capture_check_in(slug, status, **options); end

  # source://sentry-ruby//lib/sentry/hub.rb#259
  def capture_event(event, **options, &block); end

  # source://sentry-ruby//lib/sentry/hub.rb#161
  def capture_exception(exception, **options, &block); end

  # source://sentry-ruby//lib/sentry/hub.rb#226
  def capture_log_event(message, **options); end

  # source://sentry-ruby//lib/sentry/hub.rb#187
  def capture_message(message, **options, &block); end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/hub.rb#244
  ...
  # @return [Array<Client>]
  #
  # source://sentry-ruby//lib/sentry/hub.rb#59
  def clients; end

  # source://sentry-ruby//lib/sentry/hub.rb#71
  def clone; end

  # source://sentry-ruby//lib/sentry/hub.rb#63
  def configuration; end

  # source://sentry-ruby//lib/sentry/hub.rb#89
  def configure_scope(&block); end

  # source://sentry-ruby//lib/sentry/hub.rb#376
  def continue_trace(env, **options); end
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#67
  def current_scope; end

  # source://sentry-ruby//lib/sentry/hub.rb#321
  def end_session; end

  # source://sentry-ruby//lib/sentry/hub.rb#351
  def get_baggage; end

  # source://sentry-ruby//lib/sentry/hub.rb#358
  def get_trace_propagation_headers; end

  # source://sentry-ruby//lib/sentry/hub.rb#370
  def get_trace_propagation_meta; end

  # source://sentry-ruby//lib/sentry/hub.rb#344
  def get_traceparent; end
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#111
  def pop_scope; end
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#100
  def push_scope; end
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#316
  def start_session; end

  # source://sentry-ruby//lib/sentry/hub.rb#121
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#141
  def with_child_span(instrumenter: T.unsafe(nil), **attributes, &block); end

  # source://sentry-ruby//lib/sentry/hub.rb#93
  def with_scope(&block); end

  # source://sentry-ruby//lib/sentry/hub.rb#335
  def with_session_tracking(&block); end
...
# source://sentry-ruby//lib/sentry/hub.rb#400
class Sentry::Hub::Layer
  # @return [Layer] a new instance of Layer
  #
  # source://sentry-ruby//lib/sentry/hub.rb#404
  def initialize(client, scope); end

  # Returns the value of attribute client.
  #
  # source://sentry-ruby//lib/sentry/hub.rb#401
  def client; end
  ...
  #
  # source://sentry-ruby//lib/sentry/hub.rb#402
  def scope; end
end
...
class Sentry::LineCache
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/linecache.rb#34
  def getlines(path); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/linecache.rb#28
...
module Sentry::Profiler::Helpers
  # source://sentry-ruby//lib/sentry/profiler/helpers.rb#12
  ...
  # source://sentry-ruby//lib/sentry/profiler/helpers.rb#16
...
class Sentry::PropagationContext
  ...
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#121
  ...
  # @return [Baggage, nil]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#181
  def get_baggage; end
  ...
  # @return [Hash, nil]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#188
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#165
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#175
  def get_traceparent; end
  ...
  # source://sentry-ruby//lib/sentry/propagation_context.rb#194
  def populate_head_baggage; end

  class << self
    # source://sentry-ruby//lib/sentry/propagation_context.rb#94
    ...
    # @return [Boolean]
    #
    # source://sentry-ruby//lib/sentry/propagation_context.rb#61
...
class Sentry::ReleaseDetector
  class << self
    ...
    # @api private
    #
    # source://sentry-ruby//lib/sentry/release_detector.rb#20
    def detect_release_from_capistrano(project_root); end

    # @api private
    #
    # source://sentry-ruby//lib/sentry/release_detector.rb#39
    def detect_release_from_env; end

    # @api private
    #
    # source://sentry-ruby//lib/sentry/release_detector.rb#31
    def detect_release_from_git; end

    # @api private
    #
    # source://sentry-ruby//lib/sentry/release_detector.rb#15
    def detect_release_from_heroku(running_on_heroku); end

    # @api private
    #
    # source://sentry-ruby//lib/sentry/release_detector.rb#35
...
class Sentry::Scope
  ...
  #
  # source://sentry-ruby//lib/sentry/scope.rb#35
  def initialize(max_breadcrumbs: T.unsafe(nil)); end

  # Add a new attachment to the scope.
  #
  # source://sentry-ruby//lib/sentry/scope.rb#376
  def add_attachment(**opts); end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#123
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#364
  ...
  # @return [Event]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#50
  ...
  #
  # source://sentry-ruby//lib/sentry/scope.rb#88
  def apply_to_telemetry(telemetry); end

  # source://sentry-ruby//lib/sentry/scope.rb#32
  def attachments; end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#42
  def clear; end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#129
  ...
  # @return [Scope]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#134
  def dup; end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#371
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#266
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#254
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#224
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#204
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#247
  def set_tag(key, value); end

  # source://sentry-ruby//lib/sentry/scope.rb#238
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#308
  def set_transaction_name(transaction_name, source: T.unsafe(nil)); end

  # source://sentry-ruby//lib/sentry/scope.rb#218
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#322
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#156
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#384
  def attachments=(_arg0); end
  ...
  class << self
    ...
    # @return [void]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#447
    def add_global_event_processor(&block); end
    ...
    # @return [Array<Proc>]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#437
    def global_event_processors; end

    # @return [Hash]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#413
    def os_context; end

    # @return [Hash]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#428
    def runtime_context; end
  end
end

# source://sentry-ruby//lib/sentry/scope.rb#13
...
# source://sentry-ruby//lib/sentry/exceptions.rb#10
...
class Sentry::Span
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#121
  ...
  # @return [self]
  #
  # source://sentry-ruby//lib/sentry/span.rb#151
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/span.rb#109
  def origin; end
  ...
  # @param value [Object]
  #
  # source://sentry-ruby//lib/sentry/span.rb#292
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#257
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#276
  ...
  # @param origin [String]
  #
  # source://sentry-ruby//lib/sentry/span.rb#305
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#264
  ...
  # @param value [String]
  #
  # source://sentry-ruby//lib/sentry/span.rb#299
  def set_tag(key, value); end
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#270
  ...
  # @return [SpanRecorder]
  #
  # source://sentry-ruby//lib/sentry/span.rb#114
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#212
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/span.rb#168
  def to_baggage; end

  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/span.rb#179
  def to_h; end
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/span.rb#158
  ...
  # @return [Transaction]
  #
  # source://sentry-ruby//lib/sentry/span.rb#119
  def transaction; end
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#233
  def with_child_span(**attributes, &block); end
end
...
class Sentry::StacktraceBuilder
  ...
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#40
  ...
  # @return [Regexp, nil]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#11
  def app_dirs_pattern; end

  # @return [Proc, nil]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#20
  def backtrace_cleanup_callback; end
  ...
  # @return [Integer, nil]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#17
  def context_lines; end

  # @return [FilenameCache]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#26
  def filename_cache; end

  # @return [LineCache]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#14
  def linecache; end

  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#8
  def project_root; end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#23
  def strip_backtrace_load_path; end

  private

  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#95
  def convert_parsed_line_into_frame(line); end

  # source://sentry-ruby//lib/sentry/interfaces/stacktrace_builder.rb#101
...
class Sentry::StacktraceInterface::Frame < ::Sentry::Interface
  ...
  # source://sentry-ruby//lib/sentry/interfaces/stacktrace.rb#43
  def set_context(linecache, context_lines); end

  # source://sentry-ruby//lib/sentry/interfaces/stacktrace.rb#50
  def to_h(*args); end

  # source://sentry-ruby//lib/sentry/interfaces/stacktrace.rb#39
  def to_s; end
...
class Sentry::TelemetryEventBuffer < ::Sentry::ThreadedPeriodicWorker
  ...
  #
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#20
  ...
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#53
  def add_item(item); end

  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#85
  def clear!; end

  # Returns the value of attribute data_category.
  #
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#18
  def data_category; end
  ...
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#40
  def flush; end
  ...
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#81
  def size; end
  ...
  # source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#91
  def send_items; end
end

# seconds
#
# source://sentry-ruby//lib/sentry/telemetry_event_buffer.rb#15
...
class Sentry::Transaction::SpanRecorder
  ...
  # source://sentry-ruby//lib/sentry/transaction.rb#332
  def add(span); end

  # Returns the value of attribute max_length.
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#325
  def max_length; end
...
class Sentry::Transport
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/transport.rb#115
  ...
  # source://sentry-ruby//lib/sentry/transport.rb#119
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/transport.rb#93
  ...
  #
  # source://sentry-ruby//lib/sentry/transport.rb#43
  def send_data(data, options = T.unsafe(nil)); end

  # source://sentry-ruby//lib/sentry/transport.rb#54
  def send_envelope(envelope); end

  # source://sentry-ruby//lib/sentry/transport.rb#47
  def send_event(event); end

  # source://sentry-ruby//lib/sentry/transport.rb#71
  def serialize_envelope(envelope); end

  private

  # source://sentry-ruby//lib/sentry/transport.rb#193
  def fetch_pending_client_report(force: T.unsafe(nil)); end

  # source://sentry-ruby//lib/sentry/transport.rb#215
...
class Sentry::Vernier::Output
  ...
  # source://sentry-ruby//lib/sentry/vernier/output.rb#21
  def to_h; end

  private

  # source://sentry-ruby//lib/sentry/vernier/output.rb#57
  def frames; end

  # source://sentry-ruby//lib/sentry/vernier/output.rb#38
  def samples; end

  # source://sentry-ruby//lib/sentry/vernier/output.rb#85
  def stack_table_hash; end

  # source://sentry-ruby//lib/sentry/vernier/output.rb#79
  def stacks; end

  # source://sentry-ruby//lib/sentry/vernier/output.rb#32
...
class Sentry::Vernier::Profiler
  ...
  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#30
  def set_initial_sample_decision(transaction_sampled); end

  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#57
  def start; end
  ...
  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#75
  def stop; end

  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#95
  def to_h; end
  ...
  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#124
  def output; end

  # source://sentry-ruby//lib/sentry/vernier/profiler.rb#116
