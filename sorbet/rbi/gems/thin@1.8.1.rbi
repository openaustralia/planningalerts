...
class Thin::InvalidRequest < ::IOError
end
...
class Thin::InvalidHeader < ::StandardError
end

class Thin::InvalidOption < ::Thin::RunnerError
end
...
class Thin::RestartTimeout < ::RuntimeError
end

class Thin::RunnerError < ::RuntimeError
end
