...
class DBF::Column
  ...
  #
  # source://dbf//lib/dbf/column.rb#40
  ...
  # @return [Boolean]
  #
  # source://dbf//lib/dbf/column.rb#56
  def memo?; end
  ...
  # @return [Hash]
  #
  # source://dbf//lib/dbf/column.rb#63
  def to_hash; end
  ...
  # @return [String]
  #
  # source://dbf//lib/dbf/column.rb#73
  def underscored_name; end

  private

  # source://dbf//lib/dbf/column.rb#80
  def clean(value); end

  # source://dbf//lib/dbf/column.rb#84
  def encode(value, strip_output: T.unsafe(nil)); end

  # source://dbf//lib/dbf/column.rb#98
  def encode_string(string); end

  # source://dbf//lib/dbf/column.rb#91
  def encoding_args; end

  # source://dbf//lib/dbf/column.rb#102
  def type_cast_class; end

  # @raise [LengthError]
  #
  # source://dbf//lib/dbf/column.rb#109
  def validate_length; end

  # @raise [NameError]
  #
  # source://dbf//lib/dbf/column.rb#113
...
# source://dbf//lib/dbf/column.rb#16
...
module DBF::Schema
  ...
  def activerecord_schema(*_arg0); end
...
class DBF::Table
  ...
  # source://dbf//lib/dbf/table.rb#289
  def memo_search_path(io); end

  # source://dbf//lib/dbf/table.rb#295
  def open_data(data); end

  # source://dbf//lib/dbf/table.rb#301
  def open_memo(data, memo = T.unsafe(nil)); end

  # source://dbf//lib/dbf/table.rb#311
  def safe_seek; end

  # source://dbf//lib/dbf/table.rb#316
  def seek(offset); end

  # source://dbf//lib/dbf/table.rb#320
