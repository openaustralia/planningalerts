...
# source://actionpack//lib/action_controller/api.rb#0
...
# * <tt>expire_after</tt>  - The length of time a session will be stored before automatically expiring.
#
# source://actionpack//lib/action_dispatch/middleware/session/mem_cache_store.rb#19
class ActionDispatch::Session::MemCacheStore < ::Rack::Session::Dalli
  ...
  #
  # source://actionpack//lib/action_dispatch/middleware/session/mem_cache_store.rb#24
  def initialize(app, options = T.unsafe(nil)); end
end
