...
module Rack
  class << self
    # source://rack/3.2.6/lib/rack/version.rb#14
    def release; end
  end
end
...
class Rack::Session::Encryptor::V1
  ...
  #
  # @raise [ArgumentError]
  # @return [V1] a new instance of V1
  #
...
class Rack::Session::Encryptor::V2
  ...
  #
  # @raise [ArgumentError]
  # @return [V2] a new instance of V2
  #
...
class Rack::Session::Pool < ::Rack::Session::Abstract::PersistedSecure
  ...
  # source://rack-session//lib/rack/session/pool.rb#62
  def delete_session(req, session_id, options); end
  ...
  # source://rack-session//lib/rack/session/pool.rb#77
