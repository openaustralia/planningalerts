...
class Ethon::Curl::FDSet < ::FFI::Struct
  # source://ethon//lib/ethon/curls/classes.rb#40
  def clear; end
end
...
# source://ethon//lib/ethon/curls/classes.rb#45
...
module Ethon::Easy::Callbacks
  ...
  # @return [Proc] The callback.
  #
  # source://ethon//lib/ethon/easy/callbacks.rb#67
  ...
  # @return [Proc] The callback.
  #
  # source://ethon//lib/ethon/easy/callbacks.rb#90
  ...
  # @return [Proc] The callback.
  #
  # source://ethon//lib/ethon/easy/callbacks.rb#143
  ...
  # @api private
  #
  # source://ethon//lib/ethon/easy/callbacks.rb#76
  ...
  #
  # source://ethon//lib/ethon/easy/callbacks.rb#104
...
module Ethon::Easy::Informations
  ...
  # @return [Boolean] True if supported, else false.
  #
  # source://ethon//lib/ethon/easy/informations.rb#106
  def supports_zlib?; end
...
module Ethon::Easy::ResponseCallbacks
  ...
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#117
  def body(chunk); end
  ...
  #   request.complete
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#66
  def complete; end
  ...
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#105
  ...
  # @param block [Block] The block to execute.
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#56
  ...
  # @param block [Block] The block to execute.
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#79
  ...
  #
  # source://ethon//lib/ethon/easy/response_callbacks.rb#93
