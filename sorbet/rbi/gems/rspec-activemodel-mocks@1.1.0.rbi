...
# source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/version.rb#1
module RSpec
  class << self
...
# source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#6
...
module RSpec::ActiveModel::Mocks::Mocks
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#94
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#243
  def stub_model(model_class, stubs = T.unsafe(nil)); end

  private

  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#273
  def next_id; end
end
...
# source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#183
module RSpec::ActiveModel::Mocks::Mocks::ActiveModelStubExtensions
  # Stubs `persisted` to return false and `id` to return nil
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#185
  def as_new_record; end
  ...
  # @return [Boolean]
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#192
  def persisted?; end
end
...
# source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#197
module RSpec::ActiveModel::Mocks::Mocks::ActiveRecordStubExtensions
  # Stubs `id` (or other primary key method) to return nil
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#199
  def as_new_record; end
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#211
  def connection; end
  ...
  # @return [Boolean]
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#205
  def new_record?; end
end
