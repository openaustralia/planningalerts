...
module Net::SFTP
  class << self
    ...
    #   end
    #
    # source://net-sftp//lib/net/sftp.rb#30
    def start(host, user, options = T.unsafe(nil), &block); end
  end
end
...
# those, instead.
#
# source://net-sftp//lib/net/sftp/operations/download.rb#118
class Net::SFTP::Operations::Download
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#146
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#192
  def [](name); end

  # Sets the given property to the given name. This allows Download instances
  # to store their own state when used as part of a state machine.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#198
  def []=(name, value); end

  # Forces the transfer to stop.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#178
  def abort!; end
  ...
  # @return [Boolean]
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#173
  def active?; end

  # The destination of the download (the name of a file or directory on
  # the local server, or an IO object)
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#123
  def local; end

  # The hash of options that was given to this Download instance.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#130
  def options; end

  # The properties hash for this object
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#136
  def properties; end
  ...
  # @return [Boolean]
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#167
  def recursive?; end

  # The source of the download (the name of a file or directory on the
  # remote server)
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#127
  def remote; end

  # The SFTP session instance that drives this download.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#133
  def sftp; end
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#185
  def wait; end
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#317
  def download_next_chunk(entry); end

  # Called when a file handle is closed.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#345
  def on_close(response); end

  # Called when a directory handle is closed.
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#296
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#305
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#256
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/download.rb#326
...
#
# source://net-sftp//lib/net/sftp/operations/download.rb#206
...
class Net::SFTP::Operations::File
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#85
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#128
  def print(*items); end
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#136
  def puts(*items); end
  ...
  # @raise [EOFError]
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#110
  ...
  # version in use).
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#152
  def stat; end

  # Writes the given data to the stream, incrementing the file position and
  # returning the number of bytes written.
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#118
  def write(data); end
  ...
  #
  # source://net-sftp//lib/net/sftp/operations/file.rb#160
  def fill; end
end
...
#
# source://net-sftp//lib/net/sftp/packet.rb#9
...
# see Net::SFTP::Session for the recommended interface.
#
# source://net-sftp//lib/net/sftp/protocol/05/base.rb#15
...
class Net::SFTP::Session
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#691
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#698
  def block!(handle, offset, length, mask, &callback); end
  ...
  #   sftp.loop
  #
  # source://net-sftp//lib/net/sftp/session.rb#207
  ...
  #   sftp.close!(handle)
  #
  # source://net-sftp//lib/net/sftp/session.rb#216
  def close!(handle, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#727
  ...
  # @return [Boolean]
  #
  # source://net-sftp//lib/net/sftp/session.rb#739
  def closed?; end
  ...
  # to use this.
  #
  # source://net-sftp//lib/net/sftp/session.rb#153
  def dir; end
  ...
  #   download.wait
  #
  # source://net-sftp//lib/net/sftp/session.rb#114
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#122
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#140
  def file; end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#378
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#387
  def fsetstat!(handle, attrs, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#327
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#336
  def fstat!(handle, flags = T.unsafe(nil), &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#654
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#663
  def link!(new_link_path, existing_path, symlink = T.unsafe(nil), &callback); end
  ...
  #   sftp.loop
  #
  # source://net-sftp//lib/net/sftp/session.rb#800
  def loop(&block); end
  ...
  #   request.wait
  #
  # source://net-sftp//lib/net/sftp/session.rb#310
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#319
  def lstat!(path, flags = T.unsafe(nil), &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#488
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#497
  def mkdir!(path, attrs = T.unsafe(nil), &callback); end
  ...
  #   sftp.loop
  #
  # source://net-sftp//lib/net/sftp/session.rb#181
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#190
  def open!(path, flags = T.unsafe(nil), options = T.unsafe(nil), &callback); end
  ...
  # @return [Boolean]
  #
  # source://net-sftp//lib/net/sftp/session.rb#734
  def open?; end
  ...
  #   sftp.loop
  #
  # source://net-sftp//lib/net/sftp/session.rb#405
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#414
  def opendir!(path, &callback); end
  ...
  # @return [Boolean]
  #
  # source://net-sftp//lib/net/sftp/session.rb#745
  def opening?; end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#246
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#256
  def read!(handle, offset, length, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#439
  ...
  #   end
  #
  # source://net-sftp//lib/net/sftp/session.rb#451
  def readdir!(handle, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#604
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#613
  def readlink!(path, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#534
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#543
  def realpath!(path, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#465
  ...
  #   sftp.remove!("/path/to/file")
  #
  # source://net-sftp//lib/net/sftp/session.rb#474
  def remove!(filename, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#580
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#589
  def rename!(name, new_name, flags = T.unsafe(nil), &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#509
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#518
  def rmdir!(path, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#811
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#361
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#370
  def setstat!(path, attrs, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#551
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#560
  def stat!(path, flags = T.unsafe(nil), &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#627
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#636
  def symlink!(path, target, &callback); end
  ...
  # lock was acquired.
  #
  # source://net-sftp//lib/net/sftp/session.rb#710
  ...
  # return the Response object for the request.
  #
  # source://net-sftp//lib/net/sftp/session.rb#717
  def unblock!(handle, offset, length, &callback); end
  ...
  #   uploader.wait
  #
  # source://net-sftp//lib/net/sftp/session.rb#97
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#102
  def upload!(local, remote = T.unsafe(nil), options = T.unsafe(nil), &block); end
  ...
  #   request.wait
  #
  # source://net-sftp//lib/net/sftp/session.rb#272
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#281
  def write!(handle, offset, data, &callback); end
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#945
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#919
  def do_version(packet); end

  # The input buffer used to accumulate packet data
  #
  # source://net-sftp//lib/net/sftp/session.rb#824
  def input; end
  ...
  # request.
  #
  # source://net-sftp//lib/net/sftp/session.rb#829
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#857
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#893
  ...
  #
  # source://net-sftp//lib/net/sftp/session.rb#867
...
# source://net-sftp//lib/net/sftp.rb#54
class Net::SSH::Connection::Session
  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#68
  def initialize(transport, options = T.unsafe(nil)); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#94
  def [](key); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#99
  def []=(key, value); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#152
  def busy?(include_invisible = T.unsafe(nil)); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#51
  def channel_open_handlers; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#44
  def channels; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#522
  def cleanup_channel(channel); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#121
  def close; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#114
  def closed?; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#255
  def ev_do_calculate_rw_wait(wait); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#270
  def ev_do_handle_events(readers, writers); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#289
  def ev_do_postprocess(was_events); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#248
  def ev_preprocess(&block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#379
  def exec(command, status: T.unsafe(nil), &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#420
  def exec!(command, status: T.unsafe(nil), &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#493
  def forward; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#105
  def host; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#481
  def listen_to(io, &callback); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#47
  def listeners; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#177
  def loop(wait = T.unsafe(nil), &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#532
  def max_select_wait_time; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#517
  def on_global_request(type, &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#507
  def on_open_channel(type, &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#338
  def open_channel(type = T.unsafe(nil), *extra, &on_confirm); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#38
  def options; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#54
  def pending_requests; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#262
  def postprocess(readers, writers); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#237
  def preprocess(&block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#225
  def process(wait = T.unsafe(nil), &block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#41
  def properties; end

  # source://net-scp/4.0.0/lib/net/scp.rb#445
  def scp; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#311
  def send_global_request(type, *extra, &callback); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#443
  ...
  #   end
  #
  # source://net-sftp//lib/net/sftp.rb#63
  def sftp(wait = T.unsafe(nil)); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#136
  def shutdown!; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#487
  def stop_listening_to(io); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#35
  def transport; end

  private

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#682
  def channel_close(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#568
  def channel_closed(channel); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#667
  def channel_data(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#677
  def channel_eof(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#672
  def channel_extended_data(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#694
  def channel_failure(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#612
  def channel_open(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#645
  def channel_open_confirmation(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#651
  def channel_open_failure(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#662
  def channel_request(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#689
  def channel_success(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#657
  def channel_window_adjust(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#545
  def dispatch_incoming_packets(raise_disconnect_errors: T.unsafe(nil)); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#539
  def each_channel(&block); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#562
  def force_channel_cleanup_on_close; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#558
  def get_next_channel_id; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#579
  def global_request(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#699
  def io_select_wait(wait); end

  def loop_forever; end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#602
  def request_failure(packet); end

  # source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#595
  def request_success(packet); end
end

# source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#32
Net::SSH::Connection::Session::DEFAULT_IO_SELECT_TIMEOUT = T.let(T.unsafe(nil), Integer)

# source://net-ssh/7.0.1/lib/net/ssh/connection/session.rb#703
