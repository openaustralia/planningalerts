...
module Administrate::ApplicationController::HelperMethods
  ...
  def authorized_action?(*args, **_arg1, &block); end
  def existing_action?(*args, **_arg1, &block); end
...
class Administrate::Field::Associative < ::Administrate::Field::Base
  # source://administrate//lib/administrate/field/associative.rb#30
  def associated_class; end

  # source://administrate//lib/administrate/field/associative.rb#38
  ...
  # source://administrate//lib/administrate/field/associative.rb#61
  def association_primary_key; end

  # source://administrate//lib/administrate/field/associative.rb#81
  def deprecated_option(name); end

  # source://administrate//lib/administrate/field/associative.rb#69
  def foreign_key; end

  # @return [Boolean]
  #
  # source://administrate//lib/administrate/field/associative.rb#77
  def option_given?(name); end

  # source://administrate//lib/administrate/field/associative.rb#55
  def primary_key; end
  ...
  class << self
    ...
    def association_primary_key_for(resource_class, attr); end
...
class Administrate::Field::BelongsTo < ::Administrate::Field::Associative
  ...
  # source://administrate//lib/administrate/field/belongs_to.rb#37
  def include_blank_option; end

  # source://administrate//lib/administrate/field/belongs_to.rb#20
  def permitted_attribute; end

  # source://administrate//lib/administrate/field/belongs_to.rb#33
  def selected_option; end

  private

  # source://administrate//lib/administrate/field/belongs_to.rb#43
  def candidate_resources; end

  # source://administrate//lib/administrate/field/belongs_to.rb#50
...
class Administrate::Field::Deferred
  ...
  def html_class(*_arg0, **_arg1, &_arg2); end
...
class Administrate::Field::Polymorphic < ::Administrate::Field::BelongsTo
  ...
  # source://administrate//lib/administrate/field/polymorphic.rb#43
  def candidate_resources_for(klass); end

  # source://administrate//lib/administrate/field/polymorphic.rb#32
  def classes; end

  # source://administrate//lib/administrate/field/polymorphic.rb#47
  def display_candidate_resource(resource); end

  # source://administrate//lib/administrate/field/polymorphic.rb#39
  def order; end
...
class Administrate::Field::Select < ::Administrate::Field::Base
  # @return [Boolean]
  #
  # source://administrate//lib/administrate/field/select.rb#31
  def active_record_enum?; end

  # source://administrate//lib/administrate/field/select.rb#35
  def active_record_enum_values; end

  # source://administrate//lib/administrate/field/select.rb#27
  def include_blank_option; end
...
class Administrate::Order
  ...
  # source://administrate//lib/administrate/order.rb#102
  def order_by_association_id(relation); end

  # source://administrate//lib/administrate/order.rb#121
  def order_by_association_id_query; end

  # source://administrate//lib/administrate/order.rb#92
  def order_by_attribute(relation); end

  # source://administrate//lib/administrate/order.rb#125
  def order_by_attribute_query; end

  # source://administrate//lib/administrate/order.rb#76
  def order_by_belongs_to(relation); end

  # source://administrate//lib/administrate/order.rb#67
  def order_by_count(relation); end

  # source://administrate//lib/administrate/order.rb#84
  def order_by_has_one(relation); end

  # source://administrate//lib/administrate/order.rb#98
  def order_by_id(relation); end

  # source://administrate//lib/administrate/order.rb#117
...
class Administrate::ResourceResolver
  ...
  #
  # source://administrate//lib/administrate/resource_resolver.rb#42
