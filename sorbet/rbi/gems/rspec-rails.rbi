...
module RSpec::Rails::Matchers
  ...
  def enqueue_email(mailer_class, mail_method_name); end
  def enqueue_job(job = nil); end
  def enqueue_mail(mailer_class, mail_method_name); end
  def have_been_enqueued; end
  def have_enqueued_email(mailer_class, mail_method_name); end
  def have_enqueued_job(job = nil); end
  def have_enqueued_mail(mailer_class, mail_method_name); end
