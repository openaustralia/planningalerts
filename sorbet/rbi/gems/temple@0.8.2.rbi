...
class Temple::ERB::Engine < ::Temple::Engine
end
...
class Temple::ERB::Template < ::Temple::Templates::Tilt
end
...
class Temple::FilterError < ::RuntimeError
end
...
class Temple::Filters::StringSplitter::SyntaxChecker::ParseError < ::StandardError
end
...
class Temple::InvalidExpression < ::RuntimeError
end
