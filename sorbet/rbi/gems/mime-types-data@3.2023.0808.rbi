...
class MIME::Types
  ...
  # source://mime-types/3.5.0/lib/mime/types.rb#75
  def initialize; end

  # source://mime-types/3.5.0/lib/mime/types.rb#125
  def [](type_id, complete: T.unsafe(nil), registered: T.unsafe(nil)); end

  # source://mime-types/3.5.0/lib/mime/types.rb#167
  def add(*types); end

  # source://mime-types/3.5.0/lib/mime/types.rb#188
  def add_type(type, quiet = T.unsafe(nil)); end

  # source://mime-types/3.5.0/lib/mime/types.rb#81
  def count; end

  # source://mime-types/3.5.0/lib/mime/types.rb#90
  def each; end

  # source://mime-types/3.5.0/lib/mime/types.rb#85
  def inspect; end

  # source://mime-types/3.5.0/lib/mime/types.rb#153
  def of(filename); end
  ...
  # source://mime-types/3.5.0/lib/mime/types.rb#201
  def add_type_variant!(mime_type); end

  # source://mime-types/3.5.0/lib/mime/types.rb#211
  def index_extensions!(mime_type); end

  # source://mime-types/3.5.0/lib/mime/types.rb#221
  def match(pattern); end

  # source://mime-types/3.5.0/lib/mime/types.rb#215
  def prune_matches(matches, complete, registered); end

  # source://mime-types/3.5.0/lib/mime/types.rb#205
  def reindex_extensions!(mime_type); end

  class << self
    # source://mime-types/3.5.0/lib/mime/types/registry.rb#14
    def [](type_id, complete: T.unsafe(nil), registered: T.unsafe(nil)); end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#39
    def add(*types); end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#19
    def count; end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#24
    def each; end

    # source://mime-types/3.5.0/lib/mime/types/logger.rb#12
    def logger; end

    # source://mime-types/3.5.0/lib/mime/types/logger.rb#12
    def logger=(_arg0); end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#7
    def new(*_arg0); end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#33
    def of(filename); end
    ...
    # source://mime-types/3.5.0/lib/mime/types/registry.rb#75
    def __instances__; end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#55
    def __types__; end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#45
    def lazy_load?; end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#65
    def load_default_mime_types(mode = T.unsafe(nil)); end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#60
    def load_mode; end

    # source://mime-types/3.5.0/lib/mime/types/registry.rb#79
