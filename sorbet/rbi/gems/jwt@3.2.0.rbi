...
class JWT::Configuration::DecodeConfiguration
  ...
  #
  # source://jwt//lib/jwt/configuration/decode_configuration.rb#43
  def initialize; end
  ...
  # @api private
  #
  # source://jwt//lib/jwt/configuration/decode_configuration.rb#58
  def to_h; end
...
class JWT::Decode
  ...
  # source://jwt//lib/jwt/decode.rb#125
...
#
# source://jwt//lib/jwt/encoded_token/claims_context.rb#7
class JWT::EncodedToken
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#29
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#168
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#61
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#49
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#23
  def jwt; end
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#67
  def payload; end
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#88
  ...
  # @return [Hash] the payload.
  #
  # source://jwt//lib/jwt/encoded_token.rb#76
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#114
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#175
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#139
  ...
  #
  # source://jwt//lib/jwt/encoded_token.rb#156
  ...
  # @return [nil]
  #
  # source://jwt//lib/jwt/encoded_token.rb#127
  def verify_signature!(algorithm:, key: T.unsafe(nil), key_finder: T.unsafe(nil)); end

  private

  # source://jwt//lib/jwt/encoded_token.rb#183
  ...
  # source://jwt//lib/jwt/encoded_token.rb#212
  def parse(segment); end

  # source://jwt//lib/jwt/encoded_token.rb#204
  def parse_and_decode(segment); end

  # source://jwt//lib/jwt/encoded_token.rb#208
  def parse_unencoded(segment); end

  # @return [Boolean]
  #
  # source://jwt//lib/jwt/encoded_token.rb#200
  def unencoded_payload?; end
end

# Allow access to the unverified payload for claim verification.
#
# source://jwt//lib/jwt/encoded_token/claims_context.rb#9
class JWT::EncodedToken::ClaimsContext
  extend ::Forwardable

  # @return [ClaimsContext] a new instance of ClaimsContext
  #
  # source://jwt//lib/jwt/encoded_token/claims_context.rb#14
  def initialize(token); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def header(*args, **_arg1, &block); end

  # source://jwt//lib/jwt/encoded_token/claims_context.rb#18
  def payload; end
...
module JWT::JWA
  class << self
    # @api private
    #
    # source://jwt//lib/jwt/jwa.rb#38
    def create_signer(algorithm:, key:); end

    # @api private
    #
    # source://jwt//lib/jwt/jwa.rb#49
    ...
    # @api private
    #
    # source://jwt//lib/jwt/jwa.rb#31
    def resolve_and_sort(algorithms:, preferred_algorithm:); end

    # @api private
    # @raise [error_class]
    #
    # source://jwt//lib/jwt/jwa.rb#60
...
class JWT::JWA::Hmac
  ...
  # source://jwt//lib/jwt/jwa/hmac.rb#23
  def sign(data:, signing_key:); end
...
#
# source://jwt//lib/jwt/jwa/hmac.rb#61
module JWT::JWA::Hmac::SecurityUtils
  ...
  # @raise [ArgumentError]
  #
  # source://jwt//lib/jwt/jwa/hmac.rb#68
  ...
  #
  # source://jwt//lib/jwt/jwa/hmac.rb#92
...
# @api private
#
# source://jwt//lib/jwt/jwa/signer_context.rb#6
class JWT::JWA::SignerContext
  # @api private
  # @return [SignerContext] a new instance of SignerContext
  #
  # source://jwt//lib/jwt/jwa/signer_context.rb#9
  def initialize(jwa:, key:); end

  # @api private
  #
  # source://jwt//lib/jwt/jwa/signer_context.rb#7
  def jwa; end

  # @api private
  #
  # source://jwt//lib/jwt/jwa/signer_context.rb#14
...
# @api private
#
# source://jwt//lib/jwt/jwa/verifier_context.rb#6
class JWT::JWA::VerifierContext
  # @api private
  # @return [VerifierContext] a new instance of VerifierContext
  #
  # source://jwt//lib/jwt/jwa/verifier_context.rb#9
  def initialize(jwa:, keys:); end

  # @api private
  #
  # source://jwt//lib/jwt/jwa/verifier_context.rb#7
  def jwa; end

  # @api private
  #
  # source://jwt//lib/jwt/jwa/verifier_context.rb#14
