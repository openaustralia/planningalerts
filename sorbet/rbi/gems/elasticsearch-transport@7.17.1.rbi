...
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#18
...
# @since 7.0.0
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#23
module Elasticsearch::Loggable
  ...
  # @since 7.0.0
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#33
  ...
  # @since 7.0.0
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#45
  ...
  # @since 7.0.0
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#57
  ...
  # @since 7.0.0
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#69
  ...
  # @since 7.0.0
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/loggable.rb#81
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#27
class Elasticsearch::Transport::Client
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#135
  def initialize(arguments = T.unsafe(nil), &block); end

  # Performs a request through delegation to {#transport}.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#189
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#68
  def transport; end
  ...
  # @return [Symbol]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#362
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#380
  ...
  # @return [Array<Hash>]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#290
  def __extract_hosts(hosts_config); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#306
  def __parse_host(host); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#246
  def add_header(header); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#254
  def extract_cloud_creds(arguments); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#202
  def set_api_key; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#209
  def set_compatibility_header; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#221
...
# @since 7.2.0
#
# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#56
...
# @since 7.0.0
#
# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#50
Elasticsearch::Transport::Client::DEFAULT_HOST = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#31
...
# @since 7.2.0
#
# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#61
Elasticsearch::Transport::Client::DEFAULT_PORT = T.let(T.unsafe(nil), Integer)

# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#39
Elasticsearch::Transport::Client::DEFAULT_TRACER = T.let(T.unsafe(nil), Proc)

# source://elasticsearch-transport//lib/elasticsearch/transport/client.rb#29
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#26
module Elasticsearch::Transport::MetaHeader
  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#65
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#72
  def client_meta_version(version); end

  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#60
  def elasticsearch?; end

  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#55
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#100
  def meta_header_adapter; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#80
  def meta_header_engine; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#43
  def meta_header_service_version; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/meta_header.rb#27
...
# @since 6.1.1
#
# source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#25
class Elasticsearch::Transport::Redacted < ::Hash
  # @return [Redacted] a new instance of Redacted
  # @since 6.1.1
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#27
  ...
  # @since 6.1.1
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#48
  def inspect; end
  ...
  # @since 6.1.1
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#57
  def to_s; end
  ...
  # @since 6.1.1
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#69
  def redact(k, v, method); end

  # @since 6.1.1
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#63
...
# @since 6.1.1
#
# source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#35
...
# @since 6.1.1
#
# source://elasticsearch-transport//lib/elasticsearch/transport/redacted.rb#41
Elasticsearch::Transport::Redacted::STRING_REPLACEMENT = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#20
module Elasticsearch::Transport::Transport; end

# @abstract Module with common functionality for transport implementations.
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#23
module Elasticsearch::Transport::Transport::Base
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#49
  def initialize(arguments = T.unsafe(nil), &block); end
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#170
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#147
  ...
  # @api private
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#178
  ...
  # @api private
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#225
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#234
  ...
  # @api private
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#186
  ...
  # @api private
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#216
  ...
  # @return [Connections::Collection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#123
  ...
  # @api private
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#200
  def __trace(method, path, params, headers, body, url, response, json, took, duration); end

  # Returns the value of attribute connections.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#34
  def connections; end
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#86
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#363
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#35
  def logger; end
  ...
  # @return [Response]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#261
  ...
  # @see Sniffer#hosts
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#98
  def reload_connections!; end
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#111
  ...
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#424
  def apply_headers(client, options); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#381
  def compress_request(body, headers); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#450
  def connection_headers(connection); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#402
  def decompress_response(body); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#432
  def find_value(hash, regex); end

  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#414
  def gzipped?(body); end

  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#420
  def use_compression?; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#440
  def user_agent_header(client); end
end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#371
Elasticsearch::Transport::Transport::Base::ACCEPT_ENCODING = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#372
Elasticsearch::Transport::Transport::Base::CONTENT_ENCODING = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#374
Elasticsearch::Transport::Transport::Base::CONTENT_TYPE_REGEX = T.let(T.unsafe(nil), Regexp)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#373
Elasticsearch::Transport::Transport::Base::CONTENT_TYPE_STR = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#375
Elasticsearch::Transport::Transport::Base::DEFAULT_CONTENT_TYPE = T.let(T.unsafe(nil), String)

# Requests
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#30
Elasticsearch::Transport::Transport::Base::DEFAULT_MAX_RETRIES = T.let(T.unsafe(nil), Integer)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#26
Elasticsearch::Transport::Transport::Base::DEFAULT_PORT = T.let(T.unsafe(nil), Integer)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#27
Elasticsearch::Transport::Transport::Base::DEFAULT_PROTOCOL = T.let(T.unsafe(nil), String)

# Requests
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#28
Elasticsearch::Transport::Transport::Base::DEFAULT_RELOAD_AFTER = T.let(T.unsafe(nil), Integer)

# Seconds
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#29
Elasticsearch::Transport::Transport::Base::DEFAULT_RESURRECT_AFTER = T.let(T.unsafe(nil), Integer)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#31
Elasticsearch::Transport::Transport::Base::DEFAULT_SERIALIZER_CLASS = Elasticsearch::Transport::Transport::Serializer::MultiJson

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#376
Elasticsearch::Transport::Transport::Base::GZIP = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#377
Elasticsearch::Transport::Transport::Base::GZIP_FIRST_TWO_BYTES = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#378
Elasticsearch::Transport::Transport::Base::HEX_STRING_DIRECTIVE = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#379
Elasticsearch::Transport::Transport::Base::RUBY_ENCODING = T.let(T.unsafe(nil), TrueClass)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#32
Elasticsearch::Transport::Transport::Base::SANITIZED_PASSWORD = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#370
Elasticsearch::Transport::Transport::Base::USER_AGENT_REGEX = T.let(T.unsafe(nil), Regexp)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/base.rb#369
Elasticsearch::Transport::Transport::Base::USER_AGENT_STR = T.let(T.unsafe(nil), String)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#21
...
# @see Connection
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#29
class Elasticsearch::Transport::Transport::Connections::Collection
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#40
  def initialize(arguments = T.unsafe(nil)); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#94
  def [](*args); end
  ...
  # @return [self]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#108
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#58
  def alive; end
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#75
  def all; end
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#67
  def dead; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#90
  def each(&block); end
  ...
  # @return [Connection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#86
  def get_connection(options = T.unsafe(nil)); end
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#50
  def hosts; end
  ...
  # @return [self]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#118
  def remove(connections); end

  # Returns the value of attribute selector.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#34
  def selector; end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#99
  def size; end
...
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/collection.rb#32
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#32
class Elasticsearch::Transport::Transport::Connections::Connection
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#42
  def initialize(arguments = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#145
  def ==(other); end
  ...
  # @return [self]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#102
  def alive!; end

  # Returns the value of attribute connection.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#35
  def connection; end
  ...
  # @return [self]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#89
  def dead!; end
  ...
  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#80
  def dead?; end
  ...
  # @return [String]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#72
  ...
  # @return [String]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#58
  ...
  # @return [self]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#113
  def healthy!; end
  ...
  # @see #resurrectable?
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#127
  def resurrect!; end
  ...
  # @return [Boolean]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#135
  def resurrectable?; end

  # @return [String]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#154
  def to_s; end

  # Returns the value of attribute verified.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#36
  def verified; end
...
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/connection.rb#33
Elasticsearch::Transport::Transport::Connections::Connection::DEFAULT_RESURRECT_TIMEOUT = T.let(T.unsafe(nil), Integer)

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#22
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#26
module Elasticsearch::Transport::Transport::Connections::Selector::Base
  # @option arguments
  # @param arguments [Hash] a customizable set of options
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#31
  def initialize(arguments = T.unsafe(nil)); end

  # Returns the value of attribute connections.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#27
  def connections; end
  ...
  # @return [Connection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#40
  def select(options = T.unsafe(nil)); end
end

# "Random connection" selector strategy.
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#47
class Elasticsearch::Transport::Transport::Connections::Selector::Random
  ...
  # @return [Connections::Connection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#54
  def select(options = T.unsafe(nil)); end
end

# "Round-robin" selector strategy (default).
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#61
class Elasticsearch::Transport::Transport::Connections::Selector::RoundRobin
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#66
  def initialize(arguments = T.unsafe(nil)); end
  ...
  # @return [Connections::Connection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/connections/selector.rb#76
  def select(options = T.unsafe(nil)); end
end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#83
Elasticsearch::Transport::Transport::ERRORS = T.let(T.unsafe(nil), Hash)

# Generic client error
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#24
class Elasticsearch::Transport::Transport::Error < ::StandardError; end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#34
module Elasticsearch::Transport::Transport::Errors; end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#85
...
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#21
...
# @see Transport::Base
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#27
class Elasticsearch::Transport::Transport::HTTP::Faraday
  ...
  # @return [Connections::Connection]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#63
  def __build_connection(host, options = T.unsafe(nil), block = T.unsafe(nil)); end
  ...
  # @return [Array]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#73
  def host_unreachable_exceptions; end
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#35
  def perform_request(method, path, params = T.unsafe(nil), body = T.unsafe(nil), headers = T.unsafe(nil), opts = T.unsafe(nil)); end

  private

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/http/faraday.rb#79
  def user_agent_header(client); end
end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#36
Elasticsearch::Transport::Transport::HTTP_STATUSES = T.let(T.unsafe(nil), Hash)

# Wraps the response from Elasticsearch.
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/response.rb#23
class Elasticsearch::Transport::Transport::Response
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/response.rb#29
  def initialize(status, body, headers = T.unsafe(nil)); end

  # Returns the value of attribute body.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/response.rb#24
  def body; end
...
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#21
module Elasticsearch::Transport::Transport::Serializer; end

# An abstract class for implementing serializer implementations
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#25
module Elasticsearch::Transport::Transport::Serializer::Base
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#28
  def initialize(transport = T.unsafe(nil)); end
end

# A default JSON serializer (using [MultiJSON](http://rubygems.org/gems/multi_json))
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#35
class Elasticsearch::Transport::Transport::Serializer::MultiJson
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#46
  def dump(object, options = T.unsafe(nil)); end

  # De-serialize a Hash from JSON string
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/serializer/multi_json.rb#40
  def load(string, options = T.unsafe(nil)); end
end

# Elasticsearch server error (HTTP status 5xx)
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#32
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#24
class Elasticsearch::Transport::Transport::Sniffer
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#32
  ...
  # @return [Array<Hash>]
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#46
  def hosts; end

  # Returns the value of attribute timeout.
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#28
  def timeout; end
  ...
  #
  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#27
  def transport; end

  private

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#89
  def parse_address_port(publish_address); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#79
  def parse_publish_address(publish_address); end

  # source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#72
  def perform_sniff_request; end
end

# source://elasticsearch-transport//lib/elasticsearch/transport/transport/sniffer.rb#25
...
#
# source://elasticsearch-transport//lib/elasticsearch/transport/transport/errors.rb#28
