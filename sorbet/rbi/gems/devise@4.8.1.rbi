...
# source://actionpack/6.1.4.1/lib/action_dispatch/routing.rb#259
ActionDispatch::Routing::HTTP_METHODS = T.let(T.unsafe(nil), Array)

# source://devise//lib/devise/rails/routes.rb#35
class ActionDispatch::Routing::Mapper
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/mapper.rb#2303
  ...
  class << self
    # source://actionpack/6.1.4.1/lib/action_dispatch/routing/mapper.rb#411
    def normalize_name(name); end

    # source://actionpack/6.1.4.1/lib/action_dispatch/routing/mapper.rb#394
    def normalize_path(path); end
  end
end

# source://actionpack/6.1.4.1/lib/action_dispatch/routing/mapper.rb#14
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#365
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#614
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#583
  def add_route(mapping, name); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#618
  def add_url_helper(name, options, &block); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#394
  def api_only?; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#414
  def append(&block); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#839
  def call(env); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#438
  def clear!; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#335
  def default_scope; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#335
  def default_scope=(_arg0); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#337
  def default_url_options; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#337
  def default_url_options=(_arg0); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#460
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#336
  def disable_clear_and_finalize; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#336
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#407
  def draw(&block); end
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#384
  def eager_load!; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#579
  def empty?; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#338
  def env_key; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#759
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#791
  def find_relative_url_root(options); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#787
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#763
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#487
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#456
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#783
  def optimize_routes_generation?; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#795
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#338
  def polymorphic_mappings; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#418
  def prepend(&block); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#845
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#860
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#390
  def relative_url_root; end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#398
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#800
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#479
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#422
  def eval_block(block); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#774
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#402
  def make_request(env); end

  class << self
    # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#342
    def default_resources_path_names; end

    # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#346
    def new_with_config(config); end
  end
end

# source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#363
ActionDispatch::Routing::RouteSet::DEFAULT_CONFIG = T.let(T.unsafe(nil), ActionDispatch::Routing::RouteSet::Config)

# source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#332
ActionDispatch::Routing::RouteSet::PATH = T.let(T.unsafe(nil), Proc)

# source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#779
ActionDispatch::Routing::RouteSet::RESERVED_OPTIONS = T.let(T.unsafe(nil), Array)

# source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#333
ActionDispatch::Routing::RouteSet::UNKNOWN = T.let(T.unsafe(nil), Proc)

# source://actionpack/6.1.4.1/lib/action_dispatch/routing.rb#258
...
class Devise::FailureApp < ::ActionController::Metal
  ...
  # source://actionpack/6.1.4.1/lib/action_dispatch/routing/url_for.rb#95
  def default_url_options; end
  ...
  # source://activesupport/6.1.4.1/lib/active_support/configurable.rb#111
  def logger; end

  # source://activesupport/6.1.4.1/lib/active_support/configurable.rb#112
  ...
  class << self
    # source://actionpack/6.1.4.1/lib/action_dispatch/routing/route_set.rb#563
    def _routes; end
