...
# source://optparse/0.2.0/optparse.rb#428
...
module RDF
  class << self
    ...
    # @return [Class]
    #
    # source://rdf//lib/rdf.rb#220
    def Vocabulary(uri); end

    # @return [#to_s] property
    # @return [URI]
    #
    # source://rdf//lib/rdf.rb#236
    def [](property); end
...
#
# source://rdf//lib/rdf/model/uri.rb#1385
RDF::IRI = RDF::URI
...
class RDF::List
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#451
  def <<(value); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#553
  def [](*args); end
  ...
  # @since 1.1.15
  #
  # source://rdf//lib/rdf/model/list.rb#345
  def []=(*args); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#609
  def at(index); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#435
  def clear; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#826
  def each; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#846
  def each_statement(&block); end
  ...
  # @yield [subject]
  #
  # source://rdf//lib/rdf/model/list.rb#803
  def each_subject; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#700
  def eighth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#478
  def eql?(other); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#589
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#667
  def fifth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#623
  def first; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#769
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#656
  def fourth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#536
  def index(value); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#973
  def inspect; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#866
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#734
  def last; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#789
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#519
  def length; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#711
  def ninth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#745
  def rest; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#778
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#878
  def reverse; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#634
  def second; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#689
  def seventh; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#414
  def shift; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#678
  def sixth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#890
  def sort(&block); end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#902
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#722
  def tenth; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#645
  def third; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#926
  def to_a; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#962
  def to_s; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#950
  def to_term; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#914
  def uniq; end
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#393
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#571
  def slice_with_range(range); end

  # @private
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#565
  ...
  # @since 0.2.3
  #
  # source://rdf//lib/rdf/model/list.rb#988
...
class RDF::NTriples::Writer < ::RDF::Writer
  ...
  # @yieldreturn [void]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#190
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#307
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#253
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#230
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#220
  def format_statement(statement, **options); end
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#241
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#263
  ...
  # @return [void]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#199
  ...
  # @return [void]
  #
  # source://rdf//lib/rdf/ntriples/writer.rb#210
  ...
  class << self
    ...
    # @see http://www.w3.org/TR/rdf-testcases/#ntrip_strings
    #
    # source://rdf//lib/rdf/ntriples/writer.rb#145
    ...
    # @see http://www.w3.org/TR/rdf-testcases/#ntrip_strings
    #
    # source://rdf//lib/rdf/ntriples/writer.rb#153
    ...
    # @return [String]
    #
    # source://rdf//lib/rdf/ntriples/writer.rb#164
    def serialize(value); end
  end
end
...
#
# source://rdf//lib/rdf/model/uri.rb#27
class RDF::URI
  include ::RDF::Value
  include ::Comparable
  include ::RDF::Term
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#226
  ...
  # @see RDF::URI#join
  #
  # source://rdf//lib/rdf/model/uri.rb#555
  def +(other); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#500
  def /(fragment); end
  ...
  # @see http://www.w3.org/TR/rdf-sparql-query/#func-RDFterm-equal
  #
  # source://rdf//lib/rdf/model/uri.rb#760
  def ==(other); end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#784
  def ===(other); end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#802
  def =~(pattern); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#1314
  def _dump(level); end
  ...
  # @return [Boolean] `true` or `false`
  #
  # source://rdf//lib/rdf/model/uri.rb#306
  def absolute?; end

  # Authority is a combination of user, password, host and port
  #
  # source://rdf//lib/rdf/model/uri.rb#1152
  def authority; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1161
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#376
  def canonicalize; end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#386
  def canonicalize!; end
  ...
  # @return [RDF::URI]
  #
  # source://rdf//lib/rdf/model/uri.rb#697
  def dup; end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#728
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1128
  def fragment; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1137
  def fragment=(value); end

  # @private
  #
  # source://rdf//lib/rdf/model/uri.rb#703
  def freeze; end
  ...
  # @return [Boolean] `true` or `false`
  #
  # source://rdf//lib/rdf/model/uri.rb#601
  def has_parent?; end
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#982
  def host; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#991
  def host=(value); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#831
  def inspect; end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#424
  def join(*uris); end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#343
  def length; end
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1172
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1146
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1001
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#974
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1066
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1029
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1122
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#922
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#948
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1202
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#861
  def object; end
  ...
  # @return [RDF::URI]
  #
  # source://rdf//lib/rdf/model/uri.rb#615
  def parent; end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#871
  def parse(value); end

  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#954
  def password; end
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1042
  def path; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1051
  def path=(value); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#684
  def pname(prefixes: T.unsafe(nil)); end

  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1010
  def port; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1019
  def port=(value); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#644
  def qname(prefixes: T.unsafe(nil)); end

  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1104
  def query; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1113
  def query=(value); end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#1220
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#1267
  ...
  # @return [Boolean] `true` or `false`
  #
  # source://rdf//lib/rdf/model/uri.rb#311
  def relative?; end
  ...
  # @return [RDF::URI]
  #
  # source://rdf//lib/rdf/model/uri.rb#316
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#1301
  def request_uri; end
  ...
  # @return [RDF::URI]
  #
  # source://rdf//lib/rdf/model/uri.rb#583
  def root; end
  ...
  # @return [Boolean] `true` or `false`
  #
  # source://rdf//lib/rdf/model/uri.rb#571
  def root?; end

  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#904
  def scheme; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#913
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#824
  def to_s; end
  ...
  # @return [RDF::URI] `self`
  #
  # source://rdf//lib/rdf/model/uri.rb#813
  def to_uri; end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#258
  def uri?; end
  ...
  # @since 0.2.0
  #
  # source://rdf//lib/rdf/model/uri.rb#299
  def url?; end
  ...
  # @since 0.2.0
  #
  # source://rdf//lib/rdf/model/uri.rb#271
  def urn?; end
  ...
  #
  # source://rdf//lib/rdf/model/uri.rb#1182
  def userinfo; end

  # @param value [String, #to_s]
  # @return [RDF::URI] self
  #
  # source://rdf//lib/rdf/model/uri.rb#1191
  ...
  # @since 0.3.9
  #
  # source://rdf//lib/rdf/model/uri.rb#355
  def valid?; end
  ...
  # @since 0.3.0
  #
  # source://rdf//lib/rdf/model/uri.rb#365
  def validate!; end
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#838
  def value; end
  ...
  # source://rdf//lib/rdf/model/uri.rb#1346
  ...
  # @return [String]
  #
  # source://rdf//lib/rdf/model/uri.rb#1337
  ...
  class << self
    ...
    #
    # source://rdf//lib/rdf/model/uri.rb#1324
    def _load(data); end
    ...
    #
    # source://rdf//lib/rdf/model/uri.rb#147
    ...
    #
    # source://rdf//lib/rdf/model/uri.rb#172
    ...
    # @return [RDF::URI]
    #
    # source://rdf//lib/rdf/model/uri.rb#160
    def parse(str); end
  end
end
...
# source://rdf//lib/rdf/model/uri.rb#51
RDF::URI::IPCHAR = T.let(T.unsafe(nil), Regexp)

# source://rdf//lib/rdf/model/uri.rb#39
...
# source://rdf//lib/rdf/model/uri.rb#53
RDF::URI::IQUERY = T.let(T.unsafe(nil), Regexp)

# source://rdf//lib/rdf/model/uri.rb#67
RDF::URI::IREG_NAME = T.let(T.unsafe(nil), Regexp)

# source://rdf//lib/rdf/model/uri.rb#72
...
#
# source://rdf//lib/rdf/model/uri.rb#80
RDF::URI::IRI_PARTS = T.let(T.unsafe(nil), Regexp)

# source://rdf//lib/rdf/model/uri.rb#57
...
# source://rdf//lib/rdf/model/uri.rb#49
...
#
# source://rdf//lib/rdf/model/uri.rb#109
...
#
# source://rdf//lib/rdf/model/uri.rb#117
...
# IRI components
#
# source://rdf//lib/rdf/model/uri.rb#31
...
class RDF::Util::Cache::WeakRefCache < ::RDF::Util::Cache
  ...
  # @since 0.2.0
  #
  # source://rdf//lib/rdf/util/cache.rb#121
  def [](key); end
  ...
  # @since 0.2.0
  #
  # source://rdf//lib/rdf/util/cache.rb#136
  def []=(key, value); end
  ...
  # @since 0.2.0
  #
  # source://rdf//lib/rdf/util/cache.rb#148
  def delete(key); end
end
