...
module Sidekiq
  class << self
    # source://sidekiq/6.5.8/lib/sidekiq.rb#106
    def [](key); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#110
    def []=(key, val); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#303
    def average_scheduled_poll_interval=(interval); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#209
    def client_middleware; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#60
    def concurrency=(val); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#151
    def configure_client; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#141
    def configure_server; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#250
    def death_handlers; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#84
    def default_error_handler(ex, ctx); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#237
    def default_job_options; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#229
    def default_job_options=(hash); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#221
    ...
    # source://sidekiq/6.5.8/lib/sidekiq.rb#258
    def dump_json(object); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#294
    def ent?; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#314
    def error_handlers; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#118
    def fetch(*args, &block); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#122
    def handle_exception(ex, ctx = T.unsafe(nil)); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#254
    def load_json(string); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#262
    def log_formatter; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#270
    def log_formatter=(log_formatter); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#275
    def logger; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#279
    def logger=(logger); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#114
    def merge!(hash); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#326
    def on(event, &block); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#96
    def options; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#101
    def options=(opts); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#290
    def pro?; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#73
    def queues=(val); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#159
    def redis; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#201
    def redis=(hash); end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#181
    def redis_info; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#197
    def redis_pool; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#155
    def server?; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#215
    def server_middleware; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#332
    def strict_args!(mode = T.unsafe(nil)); end

    # source://sidekiq/6.5.8/lib/sidekiq/transaction_aware_client.rb#33
    def transactional_push!; end

    # source://sidekiq/6.5.8/lib/sidekiq.rb#55
    def ❨╯°□°❩╯︵┻━┻; end
  end
end

# source://sidekiq/6.5.8/lib/sidekiq/middleware/modules.rb#20
...
# source://sidekiq/6.5.8/lib/sidekiq.rb#20
Sidekiq::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://sidekiq/6.5.8/lib/sidekiq.rb#93
Sidekiq::DEFAULT_ERROR_HANDLER = T.let(T.unsafe(nil), Method)

# source://sidekiq/6.5.8/lib/sidekiq.rb#47
Sidekiq::FAKE_INFO = T.let(T.unsafe(nil), Hash)

# source://sidekiq/6.5.8/lib/sidekiq/job.rb#12
Sidekiq::Job = Sidekiq::Worker

# source://sidekiq/6.5.8/lib/sidekiq.rb#18
Sidekiq::LICENSE = T.let(T.unsafe(nil), String)

# source://sidekiq/6.5.8/lib/sidekiq.rb#17
...
# source://sidekiq/6.5.8/lib/sidekiq/version.rb#4
Sidekiq::VERSION = T.let(T.unsafe(nil), String)

# source://sidekiq/6.5.8/lib/sidekiq/api.rb#1158
