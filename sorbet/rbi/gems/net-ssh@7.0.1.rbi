...
module Net::SSH
  class << self
    # source://net-ssh//lib/net/ssh.rb#290
    ...
    #
    # source://net-ssh//lib/net/ssh.rb#280
    ...
    # local username
    #
    # source://net-ssh//lib/net/ssh.rb#217
    def start(host, user = T.unsafe(nil), options = T.unsafe(nil), &block); end

    private

    # source://net-ssh//lib/net/ssh.rb#303
    def _sanitize_options(options); end

    # source://net-ssh//lib/net/ssh.rb#312
...
class Net::SSH::Authentication::KeyManager
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#44
  def initialize(logger, options = T.unsafe(nil)); end

  # Add the given key_file to the list of key files that will be used.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#67
  def add(key_file); end

  # Add the given key_file to the list of keys that will be used.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#79
  def add_key_data(key_data_); end

  # Add the given keycert_file to the list of keycert files that will be used.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#73
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#215
  def agent; end
  ...
  # files.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#59
  def clear!; end
  ...
  # key_data.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#107
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#93
  def finish; end
  ...
  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#224
  def no_keys?; end
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#161
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#207
  ...
  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#200
  def use_agent?; end
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#263
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#256
  def prepare_identities_from_data; end

  # Prepares identities from user key_files for loading, preserving their order and sources.
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#231
  def prepare_identities_from_files; end

  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#297
  def process_identity_loading_error(identity, e); end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/authentication/key_manager.rb#251
...
#
# source://net-ssh//lib/net/ssh/authentication/methods/password.rb#12
...
#
# source://net-ssh//lib/net/ssh/authentication/methods/publickey.rb#14
...
class Net::SSH::Authentication::Session
  ...
  # by system default.
  #
  # source://net-ssh//lib/net/ssh/authentication/session.rb#140
  def default_keys; end

  # Returns an array of the key data that should be used when
  # attempting any key-based authentication mechanism.
  #
  # source://net-ssh//lib/net/ssh/authentication/session.rb#159
  def key_data; end

  # Returns an array of paths to the keycert files that should be used when
  # attempting any key-based authentication mechanism.
  #
  # source://net-ssh//lib/net/ssh/authentication/session.rb#153
  def keycerts; end

  # Returns an array of paths to the key files that should be used when
  # attempting any key-based authentication mechanism.
  #
  # source://net-ssh//lib/net/ssh/authentication/session.rb#147
  def keys; end
end
...
class Net::SSH::Connection::Session
  ...
  # source://net-sftp/2.1.2/lib/net/sftp.rb#63
...
#
# source://net-ssh//lib/net/ssh/connection/event_loop.rb#100
...
# source://net-ssh//lib/net/ssh/known_hosts.rb#10
...
class Net::SSH::HostKeyEntries::CertAuthority
  ...
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#53
  def initialize(key, comment: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#58
  def matches_key?(server_key); end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#42
  def ssh_types; end
end
...
class Net::SSH::HostKeyEntries::PubKey
  ...
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#13
  def initialize(key, comment: T.unsafe(nil)); end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#30
  def __getobj__; end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#35
  def matches_key?(server_key); end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#18
  def ssh_type; end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#22
  def ssh_types; end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#26
  def to_blob; end
end
...
#
# source://net-ssh//lib/net/ssh/errors.rb#47
...
# see search_for
#
# source://net-ssh//lib/net/ssh/known_hosts.rb#70
class Net::SSH::HostKeys
  include ::Enumerable

  # @return [HostKeys] a new instance of HostKeys
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#74
  def initialize(host_keys, host, known_hosts, options = T.unsafe(nil)); end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#81
  def add_host_key(key); end

  # source://net-ssh//lib/net/ssh/known_hosts.rb#86
  def each(&block); end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#90
  def empty?; end

  # Returns the value of attribute host.
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#72
  def host; end
end
...
class Net::SSH::KnownHosts
  ...
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#162
  ...
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#257
  ...
  #
  # source://net-ssh//lib/net/ssh/known_hosts.rb#179
  ...
  class << self
    ...
    # to.
    #
    # source://net-ssh//lib/net/ssh/known_hosts.rb#146
...
class Net::SSH::Transport::Algorithms
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#149
  def initialize(session, options = T.unsafe(nil)); end

  # A convenience method for accessing the list of preferred types for a
  # specific algorithm (see #algorithms).
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#193
  def [](key); end
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#180
  ...
  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#209
  ...
  # processed.
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#170
  def rekey!; end
  ...
  # @raise [ArgumentError]
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#160
  def start; end
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#363
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#290
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#437
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#421
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#406
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#382
  def negotiate_algorithms; end

  # Given the SSH name for some compression algorithm, return a normalized
  # name as a symbol.
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#491
  def normalize_compression_name(name); end

  # Parses a KEXINIT packet from the server.
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#336
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#258
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#245
  def proceed!; end
  ...
  # pending state).
  #
  # source://net-ssh//lib/net/ssh/transport/algorithms.rb#233
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://net-ssh//lib/net/ssh/transport/algorithms.rb#141
...
#
# source://net-ssh//lib/net/ssh/transport/algorithms.rb#69
...
#
# source://net-ssh//lib/net/ssh/transport/cipher_factory.rb#10
class Net::SSH::Transport::CipherFactory
  class << self
    ...
    #
    # source://net-ssh//lib/net/ssh/transport/cipher_factory.rb#77
...
class Net::SSH::Transport::IdentityCipher
  class << self
    ...
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#25
    def decrypt; end

    # Does nothing. Returns self.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#20
    def encrypt; end

    # Returns the empty string.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#35
    def final; end

    # Does nothing. Returns nil.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#45
    def iv=(v); end

    # Returns an arbitrary integer.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#15
    def iv_len; end

    # The name of this cipher, which is "identity".
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#40
    def name; end

    # Does nothing. Returns self.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#50
    def reset; end

    # Passes its single argument through unchanged.
    #
    # source://net-ssh//lib/net/ssh/transport/identity_cipher.rb#30
    def update(text); end
  end
end
...
#
# source://net-ssh//lib/net/ssh/transport/kex/diffie_hellman_group14_sha1.rb#10
...
# key-exchange algorithm.
#
# source://net-ssh//lib/net/ssh/transport/kex/diffie_hellman_group1_sha1.rb#10
...
module Net::SSH::Transport::PacketStream
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/packet_stream.rb#184
  def cleanup; end
  ...
  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/transport/packet_stream.rb#192
  ...
  #
  # source://net-ssh//lib/net/ssh/transport/packet_stream.rb#204
  ...
  # @raise [Net::SSH::Exception]
  #
  # source://net-ssh//lib/net/ssh/transport/packet_stream.rb#218
...
#
# source://net-ssh//lib/net/ssh/verifiers/accept_new_or_local_tunnel.rb#13
