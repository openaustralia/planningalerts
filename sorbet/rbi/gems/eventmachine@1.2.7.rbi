...
class EventMachine::ConnectionError < ::RuntimeError
end

class EventMachine::ConnectionNotBound < ::RuntimeError
end
...
class EventMachine::InvalidSignature < ::RuntimeError
end
...
class EventMachine::NoHandlerForAcceptedConnection < ::RuntimeError
end
...
class EventMachine::Protocols::Memcache::ParserError < ::StandardError
end
...
class EventMachine::UnknownTimerFired < ::RuntimeError
end

class EventMachine::Unsupported < ::RuntimeError
end
