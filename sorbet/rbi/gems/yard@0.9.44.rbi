...
class Rack::Request
  # source://rack/3.2.6/lib/rack/request.rb#62
  def initialize(env); end

  # source://rack/3.2.6/lib/rack/request.rb#81
  def delete_param(k); end

  # source://rack/3.2.6/lib/rack/request.rb#68
  def ip; end

  # source://rack/3.2.6/lib/rack/request.rb#72
  def params; end

  # source://rack/3.2.6/lib/rack/request.rb#72
  def query; end

  # source://rack/3.2.6/lib/rack/request.rb#76
  ...
  class << self
    # source://rack/3.2.6/lib/rack/request.rb#31
    def forwarded_priority; end

    # source://rack/3.2.6/lib/rack/request.rb#31
    def forwarded_priority=(_arg0); end

    # source://rack/3.2.6/lib/rack/request.rb#18
    def ip_filter; end

    # source://rack/3.2.6/lib/rack/request.rb#18
    def ip_filter=(_arg0); end

    # source://rack/3.2.6/lib/rack/request.rb#40
