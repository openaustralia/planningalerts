...
class Typhoeus::Response::Header < Anonymous_Delegator_100
  def [](key); end
...
class Typhoeus::Cache::Redis
  def get(request); end
  def initialize(redis = nil, options = nil); end
  def set(request, response); end
end
class Typhoeus::Cache::Dalli
  def get(request); end
  def initialize(client = nil, options = nil); end
  def set(request, response); end
end
...
class Faraday::Adapter::Typhoeus < Faraday::Adapter
  ...
  def initialize(app, adapter_options = nil); end
  def parallel?(env); end
  def perform_request(env); end
  def read_body(env); end
  def request(env); end
  def self.setup_parallel_manager(options = nil); end
