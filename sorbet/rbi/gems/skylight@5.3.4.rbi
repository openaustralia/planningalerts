...
#
# source://skylight//lib/skylight/vendor/cli/highline/menu.rb#23
...
#
# source://skylight//lib/skylight/vendor/cli/highline/question.rb#22
class HighLine::Question::NoAutoCompleteMatch < ::StandardError; end

# An internal HighLine error.  User code does not need to trap this.
#
# source://skylight//lib/skylight/vendor/cli/highline.rb#35
...
#
# source://skylight//lib/skylight/vendor/cli/highline/color_scheme.rb#119
...
module Skylight
  ...
  class << self
    ...
    #
    # source://skylight//lib/skylight.rb#219
...
class Skylight::CLI::Base < ::Thor
  ...
  # @api private
  #
  # source://skylight//lib/skylight/cli.rb#130
  def api; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/cli.rb#126
  def config_path; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/cli.rb#122
  def relative_config_path; end

  # @api private
  #
  # source://skylight//lib/skylight/cli.rb#134
  def user_config; end
end
...
class Skylight::CLI::Merger < ::Thor::Group
  ...
  # source://skylight//lib/skylight/cli/merger.rb#272
  def children; end
  ...
  # source://skylight//lib/skylight/cli/merger.rb#268
  def parent_component_fingerprints; end

  # source://skylight//lib/skylight/cli/merger.rb#296
  def specify_child_env; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/cli/merger.rb#260
...
class Skylight::Config
  ...
  # source://skylight//lib/skylight/config.rb#383
  def [](key, default = T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#401
  def []=(key, val, scope = T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#560
  ...
  #
  # source://skylight//lib/skylight/config.rb#558
  ...
  # source://skylight//lib/skylight/config.rb#757
  def as_json(*_arg0); end

  # ===== Helpers =====
  #
  # source://skylight//lib/skylight/config.rb#719
  def authentication_with_meta; end

  # source://skylight//lib/skylight/config.rb#350
  def check_file_permissions(file, key); end

  # source://skylight//lib/skylight/config.rb#371
  def check_logfile_permissions(log_file, key); end

  # source://skylight//lib/skylight/config.rb#682
  def check_sockdir_permissions(sockdir_path); end

  # source://skylight//lib/skylight/config.rb#749
  def component; end

  # source://skylight//lib/skylight/config.rb#739
  def components; end

  # source://skylight//lib/skylight/config.rb#735
  def deploy; end

  # source://skylight//lib/skylight/config.rb#431
  ...
  # @api private
  #
  # source://skylight//lib/skylight/config.rb#481
  def gc; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/config.rb#486
  def ignored_endpoints; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#378
  def key?(key); end

  # source://skylight//lib/skylight/config.rb#516
  def log_level; end
  ...
  # source://skylight//lib/skylight/config.rb#546
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#594
  def on_heroku?; end
  ...
  # source://skylight//lib/skylight/config.rb#427
  ...
  # @api private
  #
  # source://skylight//lib/skylight/config.rb#502
  def source_location_ignored_gems; end

  # source://skylight//lib/skylight/config.rb#753
  def to_json(*_arg0); end

  # source://skylight//lib/skylight/config.rb#450
  ...
  # @api private
  #
  # source://skylight//lib/skylight/config.rb#325
  def validate!; end

  # source://skylight//lib/skylight/config.rb#643
  def validate_with_server; end

  # ===== Helpers =====
  #
  # source://skylight//lib/skylight/config.rb#476
  def version; end

  # source://skylight//lib/skylight/config.rb#703
  def write(path); end

  private

  # source://skylight//lib/skylight/config.rb#623
  def cast_for_env(val); end

  # source://skylight//lib/skylight/config.rb#763
  def check_nfs(path); end

  # source://skylight//lib/skylight/config.rb#600
  def create_logger(out, level: T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#613
  def load_logger; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#768
  ...
  class << self
    ...
    #
    # source://skylight//lib/skylight/config.rb#217
    def legacy_keys; end
    ...
    # source://skylight//lib/skylight/config.rb#221
    def validators; end
  end
end
...
class Skylight::Deprecation < ::ActiveSupport::Deprecation
  ...
  class << self
    # source://activesupport/7.0.4.2/lib/active_support/deprecation/instance_delegator.rb#21
...
class Skylight::Extensions::Extension
  ...
  # source://skylight//lib/skylight/extensions.rb#88
  def allowed_meta_keys; end

  # source://skylight//lib/skylight/extensions.rb#82
  def process_instrument_options(_opts, _meta); end

  # source://skylight//lib/skylight/extensions.rb#84
...
module Skylight::Helpers
  ...
  class << self
    ...
    # @private
    #
    # source://skylight//lib/skylight/helpers.rb#215
    def included(base); end
  end
end
...
module Skylight::Helpers::ClassMethods
  ...
  #
  # source://skylight//lib/skylight/helpers.rb#124
  def instrument_class_method(name, **opts); end

  # @overload instrument_method
  # @overload instrument_method
  #
  # source://skylight//lib/skylight/helpers.rb#80
  ...
  # source://skylight//lib/skylight/helpers.rb#135
  def __sk_instrument_method_on(klass, name, title, **opts); end
end

# source://skylight//lib/skylight/helpers.rb#133
Skylight::Helpers::ClassMethods::HAS_ARGUMENT_FORWARDING = T.let(T.unsafe(nil), TrueClass)
...
class Skylight::Instrumenter
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#278
  def broken!; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#39
  def config; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#97
  def current_trace; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#101
  def current_trace=(trace); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#127
  def disable; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#69
  def disable_extension!(name); end

  # @api private
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#123
  def disabled?; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#292
  def done(span, meta = T.unsafe(nil)); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#65
  def enable_extension!(name); end

  # @api private
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#73
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#338
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#315
  def handle_instrumenter_error(trace, err); end

  # @api private
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#324
  def ignore?(trace); end

  # @api private
  # @raise [ArgumentError]
  #
  # source://skylight//lib/skylight/instrumenter.rb#232
  def instrument(cat, title = T.unsafe(nil), desc = T.unsafe(nil), meta = T.unsafe(nil)); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#77
  def log_context; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#119
  def muted=(val); end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#89
  def native_track_desc(_endpoint, _description); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#284
  def poison!; end

  # @api private
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#288
  def poisoned?; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#298
  def process(trace); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#186
  def shutdown; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#143
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#191
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#135
  def unmute; end
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#149
  ...
  class << self
    ...
    # @api private
    #
    # source://skylight//lib/skylight/instrumenter.rb#45
    def new(config); end
  end
end
...
class Skylight::Normalizers::ActionController::ProcessAction < ::Skylight::Normalizers::Normalizer
  ...
  # source://skylight//lib/skylight/normalizers/action_controller/process_action.rb#25
  def normalize_after(trace, _span, _name, payload); end

  private

  # source://skylight//lib/skylight/normalizers/action_controller/process_action.rb#35
  def controller_action(payload); end

  # source://skylight//lib/skylight/normalizers/action_controller/process_action.rb#39
  def process_meta_options(payload); end

  # source://skylight//lib/skylight/normalizers/action_controller/process_action.rb#44
  def segment_from_payload(payload); end

  # source://skylight//lib/skylight/normalizers/action_controller/process_action.rb#55
...
class Skylight::Normalizers::ActiveJob::Perform < ::Skylight::Normalizers::Normalizer
  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#25
  def normalize(trace, _name, payload); end

  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#35
  def normalize_after(trace, _span, _name, payload); end

  private

  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#53
  def maybe_set_endpoint(trace, payload); end

  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#46
  def normalize_adapter_name(adapter); end

  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#80
  def normalize_title(job_instance); end

  # source://skylight//lib/skylight/normalizers/active_job/perform.rb#41
  def process_meta_options(payload); end
...
# source://skylight//lib/skylight/normalizers/active_job/perform.rb#23
...
# @api private
#
# source://skylight//lib/skylight/normalizers.rb#99
class Skylight::Normalizers::Container
  ...
  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#108
  def each_key(&block); end

  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#104
  def keys; end

  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#112
  def normalize(trace, name, payload); end

  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#116
  def normalize_after(trace, span, name, payload); end

  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#120
...
# @api private
#
# source://skylight//lib/skylight/normalizers.rb#97
...
class Skylight::Normalizers::Normalizer
  ...
  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#82
  def process_meta(trace, _name, payload, meta, cache_key: T.unsafe(nil)); end

  # @api private
  #
  # source://skylight//lib/skylight/normalizers.rb#91
  def process_meta_options(_payload); end
...
class Skylight::Trace
  ...
  # source://skylight//lib/skylight/trace.rb#172
  def broken!; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/trace.rb#106
  def broken?; end
  ...
  # source://skylight//lib/skylight/trace.rb#98
  def config; end

  # source://skylight//lib/skylight/trace.rb#138
  def done(span, meta = T.unsafe(nil)); end
  ...
  # source://skylight//lib/skylight/trace.rb#161
  def inspect; end

  # source://skylight//lib/skylight/trace.rb#119
  def instrument(cat, title = T.unsafe(nil), desc = T.unsafe(nil), meta = T.unsafe(nil)); end
  ...
  # source://skylight//lib/skylight/trace.rb#110
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/trace.rb#102
  def muted?; end
  ...
  # source://skylight//lib/skylight/trace.rb#165
  def release; end
  ...
  # source://skylight//lib/skylight/trace.rb#88
  def segment=(value); end

  # source://skylight//lib/skylight/trace.rb#193
  def submit; end
  ...
  # source://skylight//lib/skylight/trace.rb#177
  def traced; end
  ...
  # source://skylight//lib/skylight/trace.rb#356
  def allowed_meta_keys; end

  # source://skylight//lib/skylight/trace.rb#333
  ...
  #
  # source://skylight//lib/skylight/trace.rb#261
  def deferred_spans; end

  # source://skylight//lib/skylight/trace.rb#318
  def gc_time; end
  ...
  #
  # source://skylight//lib/skylight/trace.rb#293
  def handle_unexpected_stop(expected, span); end

  # source://skylight//lib/skylight/trace.rb#360
  def maybe_warn(context, msg); end

  # source://skylight//lib/skylight/trace.rb#254
  def mute_child_instrumentation(span); end

  # source://skylight//lib/skylight/trace.rb#281
  def normalized_stop(span, time); end

  # source://skylight//lib/skylight/trace.rb#341
  def preprocess_meta(meta); end

  # source://skylight//lib/skylight/trace.rb#329
  def resolve_component(component); end

  # source://skylight//lib/skylight/trace.rb#232
  def start(time, cat, title, desc, meta, opts = T.unsafe(nil)); end

  # source://skylight//lib/skylight/trace.rb#265
  def stop(span, time); end

  # source://skylight//lib/skylight/trace.rb#221
  def track_gc(time, now); end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/trace.rb#325
  def use_pruning?; end

  # source://skylight//lib/skylight/trace.rb#346
  def validate_meta(meta); end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/trace.rb#368
  def warnings_silenced?(context); end
...
module Skylight::Util::InstrumenterMethod
  ...
  def instrumenter_method(name, block: T.unsafe(nil)); end
end

# source://skylight//lib/skylight/util/logging.rb#23
module Skylight::Util::Logging
  # source://skylight//lib/skylight/util/logging.rb#96
  def config_for_logging; end

  # @param msg [String] the message to log
  # @param args [Array] values for `Kernel#sprintf` on `msg`
  #
  # source://skylight//lib/skylight/util/logging.rb#61
  def debug(msg, *args); end

  # @param msg [String] the message to log
  # @param args [Array] values for `Kernel#sprintf` on `msg`
  #
  # source://skylight//lib/skylight/util/logging.rb#79
  ...
  # @return [String]
  #
  # source://skylight//lib/skylight/util/logging.rb#92
  def fmt(*args); end

  # @param msg [String] the message to log
  # @param args [Array] values for `Kernel#sprintf` on `msg`
  #
  # source://skylight//lib/skylight/util/logging.rb#67
  ...
  # @param args [Array] values for `Kernel#sprintf` on `msg`
  #
  # source://skylight//lib/skylight/util/logging.rb#107
  ...
  # See {trace?}.
  #
  # source://skylight//lib/skylight/util/logging.rb#41
  def log_trace(msg, *args); end

  # source://skylight//lib/skylight/util/logging.rb#73
  def log_warn(msg, *args); end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/util/logging.rb#32
  ...
  #
  # source://skylight//lib/skylight/util/logging.rb#53
  def t; end
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/util/logging.rb#28
  def trace?; end
