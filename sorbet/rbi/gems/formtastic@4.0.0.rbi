...
# source://formtastic//lib/formtastic/engine.rb#1
module Formtastic
...
#
# source://formtastic//lib/formtastic/action_class_finder.rb#7
class Formtastic::ActionClassFinder < ::Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/action_class_finder.rb#10
  def initialize(builder); end

  # source://formtastic//lib/formtastic/action_class_finder.rb#14
  def class_name(as); end
end

# source://formtastic//lib/formtastic/actions.rb#2
module Formtastic::Actions
  extend ::ActiveSupport::Autoload
end

# source://formtastic//lib/formtastic/actions/base.rb#3
module Formtastic::Actions::Base
  include ::Formtastic::LocalizedString

  # source://formtastic//lib/formtastic/actions/base.rb#8
  def initialize(builder, template, object, object_name, method, options); end

  # source://formtastic//lib/formtastic/actions/base.rb#102
  def accesskey; end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/actions/base.rb#6
  def builder; end
  ...
  # source://formtastic//lib/formtastic/actions/base.rb#86
  def button_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#90
  def button_html_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#98
  def default_button_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#49
  def default_wrapper_classes; end

  # source://formtastic//lib/formtastic/actions/base.rb#38
  def default_wrapper_html_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#71
  def default_wrapper_id; end

  # source://formtastic//lib/formtastic/actions/base.rb#94
  ...
  #
  # source://formtastic//lib/formtastic/actions/base.rb#75
  ...
  # source://formtastic//lib/formtastic/actions/base.rb#79
  def text; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/actions/base.rb#19
  def to_html; end

  # source://formtastic//lib/formtastic/actions/base.rb#23
  def wrapper(&block); end

  # source://formtastic//lib/formtastic/actions/base.rb#45
  def wrapper_class; end

  # source://formtastic//lib/formtastic/actions/base.rb#53
  def wrapper_classes_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#30
  def wrapper_html_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#59
  def wrapper_html_options_from_options; end

  # source://formtastic//lib/formtastic/actions/base.rb#63
  def wrapper_id; end

  # source://formtastic//lib/formtastic/actions/base.rb#67
  ...
  #
  # source://formtastic//lib/formtastic/actions/base.rb#113
  def check_supported_methods!; end

  # source://formtastic//lib/formtastic/actions/base.rb#117
  def i18n_key; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/actions/base.rb#130
  def new_or_persisted_object?; end

  # source://formtastic//lib/formtastic/actions/base.rb#134
  def sanitized_object_name; end

  # source://formtastic//lib/formtastic/actions/base.rb#122
...
#
# source://formtastic//lib/formtastic/actions/button_action.rb#45
class Formtastic::Actions::ButtonAction
  ...
  #
  # source://formtastic//lib/formtastic/actions/button_action.rb#60
  def to_html; end
end

# source://formtastic//lib/formtastic/actions/buttonish.rb#3
module Formtastic::Actions::Buttonish
  # source://formtastic//lib/formtastic/actions/buttonish.rb#9
  def extra_button_html_options; end

  # source://formtastic//lib/formtastic/actions/buttonish.rb#5
  def supported_methods; end
end
...
# @todo document i18n translation with :label (?)
#
# source://formtastic//lib/formtastic/actions/input_action.rb#48
class Formtastic::Actions::InputAction
  ...
  #
  # source://formtastic//lib/formtastic/actions/input_action.rb#63
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/actions/link_action.rb#56
class Formtastic::Actions::LinkAction
  ...
  # @see Formtastic::Helpers::ActionHelper#action
  #
  # source://formtastic//lib/formtastic/actions/link_action.rb#70
  def supported_methods; end

  # TODO reset_action class?
  #
  # source://formtastic//lib/formtastic/actions/link_action.rb#75
  def to_html; end

  # source://formtastic//lib/formtastic/actions/link_action.rb#81
  def url; end
end

# source://formtastic//lib/formtastic/deprecation.rb#4
...
# @private
#
# source://formtastic//lib/formtastic/engine.rb#4
class Formtastic::Engine < ::Rails::Engine; end

# source://formtastic//lib/formtastic/form_builder.rb#2
class Formtastic::FormBuilder < ::ActionView::Helpers::FormBuilder
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#97
  def initialize(object_name, object, template, options); end

  # source://formtastic//lib/formtastic/form_builder.rb#14
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#55
  def auto_index; end
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#93
  ...
  # source://formtastic//lib/formtastic/form_builder.rb#53
  def template; end
  ...
  class << self
    ...
    # @private
    #
    # source://formtastic//lib/formtastic/form_builder.rb#13
...
# source://formtastic//lib/formtastic/helpers.rb#2
module Formtastic::Helpers; end

# source://formtastic//lib/formtastic/helpers/action_helper.rb#4
module Formtastic::Helpers::ActionHelper
  ...
  # @todo document i18n keys
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#78
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#89
  ...
  #
  # source://formtastic//lib/formtastic/helpers/action_helper.rb#107
...
#
# source://formtastic//lib/formtastic/helpers/actions_helper.rb#53
module Formtastic::Helpers::ActionsHelper
  ...
  # @todo document i18n keys
  #
  # source://formtastic//lib/formtastic/helpers/actions_helper.rb#147
  def actions(*args, &block); end

  protected

  # source://formtastic//lib/formtastic/helpers/actions_helper.rb#162
  def default_actions; end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/enum.rb#4
module Formtastic::Helpers::Enum
  # Returns the enum (if defined) for the given method
  #
  # source://formtastic//lib/formtastic/helpers/enum.rb#6
  def enum_for(method); end
end

# source://formtastic//lib/formtastic/helpers/errors_helper.rb#3
module Formtastic::Helpers::ErrorsHelper
  ...
  #   <% end %>
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#41
  def semantic_errors(*args); end

  protected

  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#61
  def error_keys(method, options); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#71
  def has_errors?(method, options); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/errors_helper.rb#76
  def render_inline_errors?; end
end

# source://formtastic//lib/formtastic/helpers/errors_helper.rb#8
Formtastic::Helpers::ErrorsHelper::INLINE_ERROR_TYPES = T.let(T.unsafe(nil), Array)

# @private
#
# source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#4
module Formtastic::Helpers::FieldsetWrapper
  ...
  #
  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#24
  def field_set_and_list_wrapping(*args, &block); end

  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#51
  ...
  #
  # source://formtastic//lib/formtastic/helpers/fieldset_wrapper.rb#61
  def parent_child_index(parent); end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/file_column_detection.rb#4
module Formtastic::Helpers::FileColumnDetection
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/helpers/file_column_detection.rb#6
...
#
# source://formtastic//lib/formtastic/helpers/form_helper.rb#49
module Formtastic::Helpers::FormHelper
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#54
  def builder; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#54
  def builder=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#59
  def default_form_class; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#59
  def default_form_class=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#64
  def default_form_model_class_proc; end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#64
  def default_form_model_class_proc=(val); end

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#70
  ...
  #
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#182
  ...
  #
  # source://formtastic//lib/formtastic/helpers/form_helper.rb#153
  def semantic_form_for(record_or_name_or_array, *args, &proc); end

  protected

  # source://formtastic//lib/formtastic/helpers/form_helper.rb#194
...
#
# source://formtastic//lib/formtastic/helpers/input_helper.rb#38
module Formtastic::Helpers::InputHelper
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#232
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#306
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#254
  ...
  #
  # source://formtastic//lib/formtastic/helpers/input_helper.rb#341
...
#
# source://formtastic//lib/formtastic/helpers/inputs_helper.rb#46
module Formtastic::Helpers::InputsHelper
  ...
  # @param *args [Hash] a customizable set of options
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#279
  ...
  # generated input.
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#337
  def association_columns(*by_associations); end

  # Collects content columns (non-relation columns) for the current form object class.
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#363
  def content_columns; end

  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#310
  def default_columns_for_object; end

  # @private
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#404
  def field_set_title_from_args(*args); end

  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#317
  def fieldset_contents_from_column_list(columns); end

  # Collects all foreign key columns
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#354
  ...
  #
  # source://formtastic//lib/formtastic/helpers/inputs_helper.rb#375
  def inputs_for_nested_attributes(*args, &block); end
end

# @private
#
# source://formtastic//lib/formtastic/helpers/reflection.rb#4
module Formtastic::Helpers::Reflection
  # @private
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#15
  def association_macro_for_method(method); end

  # @private
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#20
  def association_primary_key_for_method(method); end

  # If an association method is passed in (f.input :author) try to find the
  # reflection object.
  #
  # source://formtastic//lib/formtastic/helpers/reflection.rb#7
  def reflection_for(method); end
end

# @private
#
# source://formtastic//lib/formtastic/html_attributes.rb#3
module Formtastic::HtmlAttributes
  ...
  #
  # source://formtastic//lib/formtastic/html_attributes.rb#5
  def dom_id_namespace; end

  protected

  # source://formtastic//lib/formtastic/html_attributes.rb#18
  def humanized_attribute_name(method); end
end

# @private
#
# source://formtastic//lib/formtastic/i18n.rb#5
module Formtastic::I18n
  class << self
    # source://formtastic//lib/formtastic/i18n.rb#21
    def t(*args); end
...
# source://formtastic//lib/formtastic/i18n.rb#7
Formtastic::I18n::DEFAULT_SCOPE = T.let(T.unsafe(nil), Array)

# source://formtastic//lib/formtastic/i18n.rb#8
Formtastic::I18n::DEFAULT_VALUES = T.let(T.unsafe(nil), Hash)

# source://formtastic//lib/formtastic/i18n.rb#9
...
#
# source://formtastic//lib/formtastic/input_class_finder.rb#7
class Formtastic::InputClassFinder < ::Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/input_class_finder.rb#10
  def initialize(builder); end

  # source://formtastic//lib/formtastic/input_class_finder.rb#14
  def class_name(as); end
end

# source://formtastic//lib/formtastic/inputs.rb#2
module Formtastic::Inputs
  extend ::ActiveSupport::Autoload
end

# source://formtastic//lib/formtastic/inputs/base.rb#3
module Formtastic::Inputs::Base
  ...
  # source://formtastic//lib/formtastic/inputs/base.rb#7
  def initialize(builder, template, object, object_name, method, options); end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#5
  def builder; end
  ...
  # @raise [ArgumentError]
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#37
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#22
  def warn_and_correct_option!(old_option_name, new_option_name); end

  # Usefull for deprecating options.
  #
  # source://formtastic//lib/formtastic/inputs/base.rb#30
  def warn_deprecated_option!(old_option_name, instructions); end
end

# source://formtastic//lib/formtastic/inputs/base/associations.rb#4
module Formtastic::Inputs::Base::Associations
  include ::Formtastic::Helpers::Reflection

  # :belongs_to, etc
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#8
  def association; end

  # source://formtastic//lib/formtastic/inputs/base/associations.rb#24
  def association_primary_key; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#16
  def belongs_to?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/associations.rb#20
  def has_many?; end

  # source://formtastic//lib/formtastic/inputs/base/associations.rb#12
  def reflection; end
end

# source://formtastic//lib/formtastic/inputs/base/choices.rb#4
module Formtastic::Inputs::Base::Choices
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#42
  def choice_html(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#58
  def choice_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#70
  def choice_html_safe_value(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#74
  def choice_input_dom_id(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#46
  def choice_label(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#54
  def choice_value(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#28
  def choice_wrapping(html_options, &block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#35
  def choice_wrapping_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#17
  def choices_group_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#24
  def choices_group_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#6
  def choices_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#13
  def choices_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#66
  def custom_choice_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#62
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#101
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/choices.rb#88
  def legend_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/choices.rb#84
  def value_as_class?; end
end

# source://formtastic//lib/formtastic/inputs/base/collections.rb#4
module Formtastic::Inputs::Base::Collections
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#49
  def collection; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#128
  def collection_for_boolean; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#73
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#111
  def collection_from_enum; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#124
  def collection_from_enum?; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#61
  def collection_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#22
  def label_and_value_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#26
  def label_and_value_method_from_collection(_collection); end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#6
  def label_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#10
  def label_method_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#45
  def raw_collection; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#137
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/collections.rb#147
  def send_or_call_or_object(duck, object); end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#14
  def value_method; end

  # source://formtastic//lib/formtastic/inputs/base/collections.rb#18
  def value_method_from_options; end
end

# source://formtastic//lib/formtastic/inputs/base/database.rb#4
module Formtastic::Inputs::Base::Database
  # source://formtastic//lib/formtastic/inputs/base/database.rb#6
  def column; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/database.rb#15
  def column?; end
end

# source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#4
module Formtastic::Inputs::Base::DatetimePickerish
  include ::Formtastic::Inputs::Base::Placeholder

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#51
  def default_maxlength; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#11
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#55
  def default_step; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#23
  def extra_input_html_options; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#7
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#19
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#45
  def maxlength; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#33
  def size; end

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#39
  def step; end

  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#15
  def value; end

  protected

  # source://formtastic//lib/formtastic/inputs/base/datetime_pickerish.rb#61
  def step_from_macro(sym); end
end

# source://formtastic//lib/formtastic/inputs/base/errors.rb#4
module Formtastic::Inputs::Base::Errors
  # source://formtastic//lib/formtastic/inputs/base/errors.rb#24
  def error_first_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#6
  def error_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#47
  def error_keys; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#15
  def error_list_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#29
  def error_none_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#10
  def error_sentence_html; end

  # source://formtastic//lib/formtastic/inputs/base/errors.rb#37
  def errors; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/errors.rb#33
  def errors?; end
end

# source://formtastic//lib/formtastic/inputs/base/fileish.rb#4
module Formtastic::Inputs::Base::Fileish
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/fileish.rb#6
  def file?; end
end

# source://formtastic//lib/formtastic/inputs/base/hints.rb#4
module Formtastic::Inputs::Base::Hints
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/hints.rb#16
  def hint?; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#6
  def hint_html; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#20
  def hint_text; end

  # source://formtastic//lib/formtastic/inputs/base/hints.rb#24
  def hint_text_from_options; end
end

# source://formtastic//lib/formtastic/inputs/base/html.rb#4
module Formtastic::Inputs::Base::Html
  # source://formtastic//lib/formtastic/inputs/base/html.rb#30
  def dom_id; end

  # source://formtastic//lib/formtastic/inputs/base/html.rb#39
  def dom_index; end

  # source://formtastic//lib/formtastic/inputs/base/html.rb#21
  def input_html_options; end
  ...
  # @raise [NotImplementedError]
  #
  # source://formtastic//lib/formtastic/inputs/base/html.rb#17
  def to_html; end
end

# source://formtastic//lib/formtastic/inputs/base/labelling.rb#4
module Formtastic::Inputs::Base::Labelling
  include ::Formtastic::LocalizedString

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#36
  def label_from_options; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#8
  def label_html; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#12
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#19
  def label_text; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#40
  def localized_label; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#44
  def render_label?; end

  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#28
  def requirement_text; end

  # TODO: why does this need to be memoized in order to make the inputs_spec tests pass?
  #
  # source://formtastic//lib/formtastic/inputs/base/labelling.rb#24
  def requirement_text_or_proc; end
end

# source://formtastic//lib/formtastic/inputs/base/naming.rb#4
module Formtastic::Inputs::Base::Naming
  # source://formtastic//lib/formtastic/inputs/base/naming.rb#6
  def as; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#18
  def attributized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#22
  def humanized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#35
  def input_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#14
  def sanitized_method_name; end

  # source://formtastic//lib/formtastic/inputs/base/naming.rb#10
  def sanitized_object_name; end
end

# source://formtastic//lib/formtastic/inputs/base/numeric.rb#4
module Formtastic::Inputs::Base::Numeric
  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#38
  def in_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#5
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#33
  def max_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#28
  def min_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#23
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/base/numeric.rb#42
  def wrapper_html_options; end
end

# source://formtastic//lib/formtastic/inputs/base/options.rb#4
module Formtastic::Inputs::Base::Options
  # source://formtastic//lib/formtastic/inputs/base/options.rb#10
  def formtastic_options; end

  # source://formtastic//lib/formtastic/inputs/base/options.rb#6
  def input_options; end
end

# source://formtastic//lib/formtastic/inputs/base/placeholder.rb#4
module Formtastic::Inputs::Base::Placeholder
  # source://formtastic//lib/formtastic/inputs/base/placeholder.rb#6
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/placeholder.rb#10
  def placeholder_text; end
end

# source://formtastic//lib/formtastic/inputs/base/stringish.rb#4
module Formtastic::Inputs::Base::Stringish
  # Overrides standard `input_html_options` to provide a `maxlength` and `size` attribute.
  #
  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#15
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#26
  def maxlength; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#22
  def size; end

  # @abstract Override this method in your input class to describe how the input should render itself.
  #
  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#7
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/base/stringish.rb#30
  def wrapper_html_options; end
end
...
#
# source://formtastic//lib/formtastic/inputs/base/timeish.rb#94
module Formtastic::Inputs::Base::Timeish
  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#122
  def date_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#126
  def default_date_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#149
  def fragment_id(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#167
  def fragment_input_html(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#138
  def fragment_label(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#157
  def fragment_label_html(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#153
  def fragment_name(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#172
  def fragment_prefix; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#130
  def fragment_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#134
  def fragment_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#114
  def fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#224
  def fragments_inner_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#213
  def fragments_label; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#202
  def fragments_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#209
  def fragments_wrapping_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#234
  def hidden_field_name(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#230
  def hidden_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#193
  ...
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#181
  def include_blank?; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#189
  def position(fragment); end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#185
  def positions; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#118
  def time_fragments; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#96
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/base/timeish.rb#162
  def value; end
end

# source://formtastic//lib/formtastic/inputs/base/validations.rb#4
module Formtastic::Inputs::Base::Validations
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#178
  def autofocus?; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#184
  def column_limit; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#188
  def limit; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#166
  def not_required_through_negated_validation!; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#162
  def not_required_through_negated_validation?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#174
  def optional?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#192
  def readonly?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#196
  def readonly_attribute?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#204
  def readonly_from_options?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#130
  def required?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#158
  def required_attribute?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#170
  def responds_to_global_required?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#115
  def validation_integer_only?; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#54
  def validation_limit; end

  # Prefer :less_than_or_equal_to over :less_than, for no particular reason.
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#86
  def validation_max; end

  # Prefer :greater_than_or_equal_to over :greater_than, for no particular reason.
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#66
  def validation_min; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#104
  def validation_step; end

  # source://formtastic//lib/formtastic/inputs/base/validations.rb#24
  def validations; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#126
  def validations?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#34
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#212
  def option_value(option, object); end
end

# source://formtastic//lib/formtastic/inputs/base/validations.rb#15
class Formtastic::Inputs::Base::Validations::IndeterminableMaximumAttributeError < ::ArgumentError
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#16
  def message; end
end

# source://formtastic//lib/formtastic/inputs/base/validations.rb#6
class Formtastic::Inputs::Base::Validations::IndeterminableMinimumAttributeError < ::ArgumentError
  # source://formtastic//lib/formtastic/inputs/base/validations.rb#7
  def message; end
end

# @todo relies on `dom_id`, `required?`, `optional`, `errors?`, `association_primary_key` & `sanitized_method_name` methods from another module
#
# source://formtastic//lib/formtastic/inputs/base/wrapping.rb#5
module Formtastic::Inputs::Base::Wrapping
  ...
  #
  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#9
  def input_wrapping(&block); end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#31
  def wrapper_classes; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#27
  def wrapper_classes_raw; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#43
  def wrapper_dom_id; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#16
  def wrapper_html_options; end

  # source://formtastic//lib/formtastic/inputs/base/wrapping.rb#23
...
#
# source://formtastic//lib/formtastic/inputs/boolean_input.rb#32
class Formtastic::Inputs::BooleanInput
  ...
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#65
  def check_box_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#93
  def checked?; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#73
  def checked_value; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#42
  def hidden_field_html; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#81
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#85
  def input_html_options_name; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#54
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#61
  def label_text_with_embedded_checkbox; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#46
  def label_with_nested_checkbox; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#77
  def responds_to_global_required?; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#35
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#69
  ...
  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/boolean_input.rb#99
...
#
# source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#67
class Formtastic::Inputs::CheckBoxesInput
  ...
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#72
  def initialize(*args); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#116
  def check_box_with_hidden_input(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#126
  def check_box_without_hidden_input(choice); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#140
  def checked?(value); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#93
  def choice_html(choice); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#144
  def disabled?(value); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#152
  def disabled_values; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#136
  def extra_html_options(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#101
  def hidden_field_for_all; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#112
  def hidden_fields_for_every?; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#162
  def input_name; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#148
  def selected_values; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#77
  def to_html; end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#158
  def unchecked_value; end

  protected

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#172
  def checkbox_input(choice); end

  # source://formtastic//lib/formtastic/inputs/check_boxes_input.rb#180
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/color_input.rb#28
class Formtastic::Inputs::ColorInput
  ...
  # source://formtastic//lib/formtastic/inputs/color_input.rb#33
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/country_input.rb#67
class Formtastic::Inputs::CountryInput
  ...
  # source://formtastic//lib/formtastic/inputs/country_input.rb#80
  def priority_countries; end

  # @raise [CountrySelectPluginMissing]
  #
  # source://formtastic//lib/formtastic/inputs/country_input.rb#72
  def to_html; end
end

# source://formtastic//lib/formtastic/inputs/country_input.rb#70
...
#
# source://formtastic//lib/formtastic/inputs/datalist_input.rb#13
class Formtastic::Inputs::DatalistInput
  ...
  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#35
  def data_list_html; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#31
  def html_id_of_datalist; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#27
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/datalist_input.rb#18
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/date_picker_input.rb#70
class Formtastic::Inputs::DatePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#79
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#75
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/date_picker_input.rb#83
  def value; end
end
...
#
# source://formtastic//lib/formtastic/inputs/date_select_input.rb#6
class Formtastic::Inputs::DateSelectInput
  ...
  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#25
  def fragment_value(fragment); end

  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#15
  def hidden_date_fragments; end

  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#19
  def hidden_fragments; end

  # We don't want hour and minute fragments on a date input
  #
  # source://formtastic//lib/formtastic/inputs/date_select_input.rb#11
  def time_fragments; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#78
class Formtastic::Inputs::DatetimePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#88
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#83
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/datetime_picker_input.rb#92
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# source://formtastic//lib/formtastic/inputs/datetime_select_input.rb#7
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/email_input.rb#28
class Formtastic::Inputs::EmailInput
  ...
  # source://formtastic//lib/formtastic/inputs/email_input.rb#33
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/file_input.rb#32
class Formtastic::Inputs::FileInput
  ...
  # source://formtastic//lib/formtastic/inputs/file_input.rb#34
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/hidden_input.rb#31
class Formtastic::Inputs::HiddenInput
  ...
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#44
  def error_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#48
  def errors?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#56
  def hint?; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#52
  def hint_html; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#34
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/hidden_input.rb#38
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/inputs/number_input.rb#70
class Formtastic::Inputs::NumberInput
  ...
  # source://formtastic//lib/formtastic/inputs/number_input.rb#82
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/number_input.rb#75
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/password_input.rb#28
class Formtastic::Inputs::PasswordInput
  ...
  # source://formtastic//lib/formtastic/inputs/password_input.rb#33
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/phone_input.rb#28
class Formtastic::Inputs::PhoneInput
  ...
  # source://formtastic//lib/formtastic/inputs/phone_input.rb#33
  def to_html; end
end
...
#
# source://formtastic//lib/formtastic/inputs/radio_input.rb#127
class Formtastic::Inputs::RadioInput
  ...
  # source://formtastic//lib/formtastic/inputs/radio_input.rb#147
  def choice_html(choice); end

  # Override to remove the for attribute since this isn't associated with any element, as it's
  # nested inside the legend.
  #
  # source://formtastic//lib/formtastic/inputs/radio_input.rb#157
  def label_html_options; end

  # source://formtastic//lib/formtastic/inputs/radio_input.rb#132
  def to_html; end
end
...
# @see http://api.rubyonrails.org/classes/ActiveModel/Validations/HelperMethods.html#method-i-validates_numericality_of Rails' Numericality validation documentation
#
# source://formtastic//lib/formtastic/inputs/range_input.rb#70
class Formtastic::Inputs::RangeInput
  ...
  # source://formtastic//lib/formtastic/inputs/range_input.rb#85
  def max_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#81
  def min_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#89
  def step_option; end

  # source://formtastic//lib/formtastic/inputs/range_input.rb#74
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/search_input.rb#27
class Formtastic::Inputs::SearchInput
  ...
  # source://formtastic//lib/formtastic/inputs/search_input.rb#32
  def to_html; end
end
...
# @todo Do/can we support the per-item HTML options like RadioInput?
#
# source://formtastic//lib/formtastic/inputs/select_input.rb#156
class Formtastic::Inputs::SelectInput
  ...
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#160
  def initialize(*args); end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#196
  def extra_input_html_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#176
  def include_blank; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#192
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#205
  def input_html_options_name; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#213
  def input_html_options_name_multiple; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#188
  def input_options; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#184
  def label_html_options; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#225
  def multiple?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#217
  def multiple_by_association?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#221
  def multiple_by_options?; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#180
  def prompt?; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#172
  def select_html; end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/inputs/select_input.rb#229
  def single?; end

  # source://formtastic//lib/formtastic/inputs/select_input.rb#165
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/string_input.rb#29
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/text_input.rb#28
class Formtastic::Inputs::TextInput
  ...
  # source://formtastic//lib/formtastic/inputs/text_input.rb#32
  def input_html_options; end

  # source://formtastic//lib/formtastic/inputs/text_input.rb#39
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/time_picker_input.rb#71
class Formtastic::Inputs::TimePickerInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#80
  def default_size; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#93
  def default_step; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#76
  def html_input_type; end

  # source://formtastic//lib/formtastic/inputs/time_picker_input.rb#84
  def value; end
end
...
# @see Formtastic::Inputs::Base::Timeish Timeish module for documentation of date, time and datetime input options.
#
# source://formtastic//lib/formtastic/inputs/time_select_input.rb#9
class Formtastic::Inputs::TimeSelectInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#22
  def fragment_value(fragment); end

  # we don't want year / month / day fragments if :ignore_date => true
  #
  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#14
  def fragments; end

  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#26
  def hidden_fragments; end

  # source://formtastic//lib/formtastic/inputs/time_select_input.rb#18
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/time_zone_input.rb#43
class Formtastic::Inputs::TimeZoneInput
  ...
  # source://formtastic//lib/formtastic/inputs/time_zone_input.rb#53
  def priority_zones; end

  # source://formtastic//lib/formtastic/inputs/time_zone_input.rb#46
  def to_html; end
end
...
# @see Formtastic::Helpers::InputsHelper#input InputsHelper#input for full documentation of all possible options.
#
# source://formtastic//lib/formtastic/inputs/url_input.rb#28
class Formtastic::Inputs::UrlInput
  ...
  # source://formtastic//lib/formtastic/inputs/url_input.rb#33
  def to_html; end
end

# source://formtastic//lib/formtastic/localized_string.rb#2
module Formtastic::LocalizedString
  # source://formtastic//lib/formtastic/localized_string.rb#4
  def model_name; end
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localized_string.rb#10
...
#
# source://formtastic//lib/formtastic/localizer.rb#26
class Formtastic::Localizer
  # @return [Localizer] a new instance of Localizer
  #
  # source://formtastic//lib/formtastic/localizer.rb#55
  def initialize(current_builder); end

  # Returns the value of attribute builder.
  #
  # source://formtastic//lib/formtastic/localizer.rb#49
  def builder; end
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localizer.rb#59
  ...
  # @private
  #
  # source://formtastic//lib/formtastic/localizer.rb#133
  def escape_html_entities(string); end

  # source://formtastic//lib/formtastic/localizer.rb#145
  def i18n_cache_lookups; end

  # source://formtastic//lib/formtastic/localizer.rb#141
  def i18n_lookups_by_default; end

  # source://formtastic//lib/formtastic/localizer.rb#117
  def normalize_model_name(name); end

  class << self
    # source://formtastic//lib/formtastic/localizer.rb#51
    def cache; end
  end
end

# source://formtastic//lib/formtastic/localizer.rb#27
class Formtastic::Localizer::Cache
  # source://formtastic//lib/formtastic/localizer.rb#40
  def cache; end

  # source://formtastic//lib/formtastic/localizer.rb#44
  def clear!; end

  # source://formtastic//lib/formtastic/localizer.rb#28
  def get(key); end

  # @return [Boolean]
  #
  # source://formtastic//lib/formtastic/localizer.rb#32
  def has_key?(key); end

  # source://formtastic//lib/formtastic/localizer.rb#36
...
#
# source://formtastic//lib/formtastic/namespaced_class_finder.rb#24
class Formtastic::NamespacedClassFinder
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#36
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#63
  def class_name(as); end
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#48
  def find(as); end

  # @private
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#25
  def namespaces; end

  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#52
  def resolve(as); end
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#90
  ...
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#81
  def find_with_const_defined(class_name); end

  # @private
  #
  # source://formtastic//lib/formtastic/namespaced_class_finder.rb#74
  def finder(class_name); end

  class << self
    # @return [Boolean]
    #
    # source://formtastic//lib/formtastic/namespaced_class_finder.rb#31
