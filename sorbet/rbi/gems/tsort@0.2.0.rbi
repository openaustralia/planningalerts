...
module TSort
  ...
  class << self
    ...
    #   #   1
    #
    # source://tsort//tsort.rb#226
    def tsort_each(each_node, each_child); end
  end
end

# source://tsort//tsort.rb#126
