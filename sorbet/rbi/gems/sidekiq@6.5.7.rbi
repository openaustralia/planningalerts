...
module Sidekiq
  class << self
    ...
    # deprecated
    #
    # source://activesupport/6.1.4.1/lib/active_support/deprecation/method_wrappers.rb#63
...
class Sidekiq::WebApplication
  ...
  # source://sidekiq//lib/sidekiq/web/application.rb#313
  def call(env); end
  ...
  class << self
    # source://sidekiq//lib/sidekiq/web/application.rb#354
    def after(path = T.unsafe(nil), &block); end

    # source://sidekiq//lib/sidekiq/web/application.rb#375
    def afters; end

    # source://sidekiq//lib/sidekiq/web/application.rb#350
    def before(path = T.unsafe(nil), &block); end

    # source://sidekiq//lib/sidekiq/web/application.rb#371
    def befores; end

    # source://sidekiq//lib/sidekiq/web/application.rb#342
    def helpers(mod = T.unsafe(nil), &block); end

    # source://sidekiq//lib/sidekiq/web/application.rb#362
    def run_afters(app, action); end

    # source://sidekiq//lib/sidekiq/web/application.rb#358
    def run_befores(app, action); end

    # source://sidekiq//lib/sidekiq/web/application.rb#366
...
# source://sidekiq//lib/sidekiq/web/application.rb#101
...
module Sidekiq::WebHelpers
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#196
  def current_path; end

  # source://sidekiq//lib/sidekiq/web/helpers.rb#200
  def current_status; end

  # source://sidekiq//lib/sidekiq/web/helpers.rb#357
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#209
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#184
  def namespace; end

  # source://sidekiq//lib/sidekiq/web/helpers.rb#291
  def number_with_delimiter(number); end

  # source://sidekiq//lib/sidekiq/web/helpers.rb#213
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#340
  def redis_connection_and_namespace; end

  # source://sidekiq//lib/sidekiq/web/helpers.rb#188
  def redis_info; end
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#192
  def root_path; end
  ...
  # source://sidekiq//lib/sidekiq/web/helpers.rb#336
  ...
  #
  # source://sidekiq//lib/sidekiq/web/helpers.rb#154
...
# source://sidekiq//lib/sidekiq/web/helpers.rb#264
Sidekiq::WebHelpers::RETRY_JOB_KEYS = T.let(T.unsafe(nil), Set)

# source://sidekiq//lib/sidekiq/web/helpers.rb#218
...
class Sidekiq::WorkSet
  ...
  #
  # source://sidekiq//lib/sidekiq/api.rb#1133
  def size; end
end
...
#
# source://sidekiq//lib/sidekiq/api.rb#1151
