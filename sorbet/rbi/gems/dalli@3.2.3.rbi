...
class Dalli::Protocol::Base
  ...
  # of pipelined gets
  #
  # source://dalli//lib/dalli/protocol/base.rb#219
  def finish_pipeline; end

  # source://dalli//lib/dalli/protocol/base.rb#230
  def log_marshal_err(key, err); end

  # source://dalli//lib/dalli/protocol/base.rb#235
  def log_unexpected_err(err); end

  # source://dalli//lib/dalli/protocol/base.rb#204
  def pipelined_get(keys); end

  # source://dalli//lib/dalli/protocol/base.rb#226
...
# and retries.
#
# source://dalli//lib/dalli/protocol/connection_manager.rb#13
class Dalli::Protocol::ConnectionManager
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#132
  def abort_request!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#103
  def close; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#219
  def close_on_fork; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#98
  def confirm_ready!; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#116
  def connected?; end
  ...
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#81
  def down!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#176
  def error_on_request!(err_or_string); end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#50
  def establish_connection; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#128
  def finish_request!; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#228
  def fork_detected?; end

  # Returns the value of attribute hostname.
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#27
  def hostname; end
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#232
  def log_down_detected; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#244
  def log_up_detected; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#211
  def log_warn_message(err_or_string); end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#172
  def max_allowed_failures; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#203
  def memcached_socket; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#42
  def name; end
  ...
  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#90
  def raise_down_error; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#146
  def read(count); end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#136
  def read_line; end
  ...
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#168
  def read_nonblock; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#189
  def reconnect!(message); end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#60
  def reconnect_down_server?; end

  # @return [Boolean]
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#120
  def request_in_progress?; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#195
  def reset_down_info; end

  # Returns the value of attribute sock.
  #
  # source://dalli//lib/dalli/protocol/connection_manager.rb#28
  def sock; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#94
  ...
  # source://dalli//lib/dalli/protocol/connection_manager.rb#124
  def start_request!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#73
  def up!; end

  # source://dalli//lib/dalli/protocol/connection_manager.rb#155
  def write(bytes); end
end

# source://dalli//lib/dalli/protocol/connection_manager.rb#14
