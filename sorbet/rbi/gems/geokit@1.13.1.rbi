...
class Geokit::GeoLoc < ::Geokit::LatLng
  ...
  #
  # source://geokit//lib/geokit/geo_loc.rb#121
  def city=(city); end
  ...
  #
  # source://geokit//lib/geokit/geo_loc.rb#88
  ...
  #
  # source://geokit//lib/geokit/geo_loc.rb#110
  def hash; end
  ...
  # @return [Boolean]
  #
  # source://geokit//lib/geokit/geo_loc.rb#77
  def is_us?; end
  ...
  # source://geokit//lib/geokit/geo_loc.rb#72
  def state; end
  ...
  #
  # source://geokit//lib/geokit/geo_loc.rb#93
  ...
  # @return [Boolean]
  #
  # source://geokit//lib/geokit/geo_loc.rb#81
  def success?; end
  ...
  # non-blank.
  #
  # source://geokit//lib/geokit/geo_loc.rb#138
  ...
  #
  # source://geokit//lib/geokit/geo_loc.rb#155
  def to_s; end

  # source://geokit//lib/geokit/geo_loc.rb#144
...
#
# source://geokit//lib/geokit/geocoders.rb#35
module Geokit::Geocoders
  class << self
    # source://geokit//lib/geokit/geocoders.rb#49
    def __define_accessors; end

    # source://geokit//lib/geokit/geocoders.rb#53
    def domain; end

    # source://geokit//lib/geokit/geocoders.rb#65
    def domain=(obj); end
...
#
# source://geokit//lib/geokit/geocoders/free_geo_ip.rb#4
class Geokit::Geocoders::FreeGeoIpGeocoder < ::Geokit::Geocoders::BaseIpGeocoder
  class << self
    # source://geokit//lib/geokit/geocoders/free_geo_ip.rb#7
    def do_geocode(ip, _ = T.unsafe(nil)); end

    # source://geokit//lib/geokit/geocoders/free_geo_ip.rb#28
    def parse_xml(xml); end

    def secure; end
    def secure=(value); end

    # source://geokit//lib/geokit/geocoders/free_geo_ip.rb#15
    def submit_url(ip); end
  end
end

# source://geokit//lib/geokit/geocoders/free_geo_ip.rb#19
...
class Geokit::Geocoders::Geocoder
  class << self
    ...
    # source://geokit//lib/geokit/geocoders.rb#192
    ...
    # source://geokit//lib/geokit/geocoders.rb#186
...
class Geokit::Geocoders::GoogleGeocoder < ::Geokit::Geocoders::Geocoder
  class << self
    ...
    # source://geokit//lib/geokit/geocoders/google.rb#115
    def parse_json(results); end

    def secure; end
    def secure=(value); end

    # source://geokit//lib/geokit/geocoders/google.rb#194
    def set_address_components(loc, addr); end

    # source://geokit//lib/geokit/geocoders/google.rb#187
    def set_bounds(loc, addr); end

    # source://geokit//lib/geokit/geocoders/google.rb#229
    ...
    # source://geokit//lib/geokit/geocoders/google.rb#164
...
#
# source://geokit//lib/geokit/geocoders/google.rb#155
Geokit::Geocoders::GoogleGeocoder::ACCURACY = T.let(T.unsafe(nil), Hash)

# source://geokit//lib/geokit/geocoders/google.rb#162
...
class Geokit::Geocoders::MultiGeocoder < ::Geokit::Geocoders::Geocoder
  class << self
    ...
    # source://geokit//lib/geokit/multi_geocoder.rb#70
...
class Geokit::Geocoders::OSMGeocoder < ::Geokit::Geocoders::Geocoder
  class << self
    ...
    # source://geokit//lib/geokit/geocoders/openstreetmap.rb#104
    def set_bounds(result_json, loc); end

    # source://geokit//lib/geokit/geocoders/openstreetmap.rb#97
    def set_precision(result_json, loc); end
  end
end
...
class Geokit::Geocoders::OpencageGeocoder < ::Geokit::Geocoders::Geocoder
  class << self
    ...
    # source://geokit//lib/geokit/geocoders/opencage.rb#87
    def set_precision(result_json, loc); end
  end
end

# source://geokit//lib/geokit/geocoders/openstreetmap.rb#114
...
module Geokit::Mappable
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#212
  ...
  # Geocoded
  #
  # source://geokit//lib/geokit/mappable.rb#220
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#199
  def to_lat_lng; end
...
module Geokit::Mappable::ClassMethods
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#133
  def decimal_to_dms(deg); end

  # source://geokit//lib/geokit/mappable.rb#144
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#35
  def distance_between(from, to, options = T.unsafe(nil)); end

  # source://geokit//lib/geokit/mappable.rb#57
  def distance_between_flat(from, to, units); end

  # source://geokit//lib/geokit/mappable.rb#48
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#89
  ...
  # @raise [Geokit::Geocoders::GeocodeError]
  #
  # source://geokit//lib/geokit/mappable.rb#125
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#185
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#116
  def midpoint_between(from, to, options = T.unsafe(nil)); end

  # source://geokit//lib/geokit/mappable.rb#148
  def rad2deg(rad); end

  # source://geokit//lib/geokit/mappable.rb#152
  def to_heading(rad); end

  # Returns the number of units per latitude degree.
  #
  # source://geokit//lib/geokit/mappable.rb#174
  def units_per_latitude_degree(units); end

  # Returns the number units per longitude degree.
  #
  # source://geokit//lib/geokit/mappable.rb#179
  ...
  #
  # source://geokit//lib/geokit/mappable.rb#169
  def units_sphere_multiplier(units); end

  class << self
    # source://geokit//lib/geokit/mappable.rb#156
...
class OauthUtil
  ...
  #
  # source://geokit//lib/geokit/geocoders/yahoo.rb#135
  ...
  #
  # source://geokit//lib/geokit/geocoders/yahoo.rb#148
  def sign(parsed_url); end

  # source://geokit//lib/geokit/geocoders/yahoo.rb#120
  def signature; end

  # source://geokit//lib/geokit/geocoders/yahoo.rb#143
  def timestamp; end
