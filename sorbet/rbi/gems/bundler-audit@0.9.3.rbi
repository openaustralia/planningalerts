...
# source://bundler-audit//lib/bundler/audit/results/result.rb#3
module Bundler::Audit::Results; end

# @abstract
#
# source://bundler-audit//lib/bundler/audit/results/result.rb#7
class Bundler::Audit::Results::Result
  # @abstract
  # @raise [NotImplementedError]
  # @return [Hash{Symbol => Object}]
  #
  # source://bundler-audit//lib/bundler/audit/results/result.rb#14
  def to_h; end
end
...
# upgraded.
#
# source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#29
class Bundler::Audit::Results::UnpatchedGem < ::Bundler::Audit::Results::Result
  ...
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#50
  ...
  # @return [Boolean]
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#62
  def ==(other); end
  ...
  # @return [Advisory]
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#39
  def advisory; end
  ...
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#34
  def gem; end
  ...
  # @return [Hash{Symbol => Object}]
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#84
  def to_h; end
  ...
  # @return [String]
  #
  # source://bundler-audit//lib/bundler/audit/results/unpatched_gem.rb#75
  def to_s; end
end
