...
class ImportApplicationsJob
  sig { params(authority: T.untyped, scrape_delay: T.untyped).void }
  def self.perform_later(authority:, scrape_delay:); end

  sig { params(authority: T.untyped, scrape_delay: T.untyped).void }
  def self.perform_now(authority:, scrape_delay:); end
