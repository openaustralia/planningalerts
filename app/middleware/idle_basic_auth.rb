...
# Ours says public, so that protection doesn't apply. Once somebody signs in and
# loads a page, the CSS, JS, fonts and images behind it can sit in Cloudflare's
# cache and be served to anyone who asks. No personal data is in any of them,
# which is why this has been left as it is.
#
