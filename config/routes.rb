...
PlanningalertsApp::Application.routes.draw do
  ...
  get  'subscriptions/backers_new' => 'subscriptions#backers_new', as: :backers_new
  post  'subscriptions/backers_create' => 'subscriptions#backers_create', as: :backers_create
