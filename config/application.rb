...
module PlanningalertsApp
  class Application < Rails::Application
    ...
    config.assets.precompile += %w[tailwind.css email.css standard/all.css standard/print.css standard/ie.css maps.js applications.js tailwind/application.js flatpickr.js bar_graph.js tailwind/bar_graph.js stacked_area_chart.js]
