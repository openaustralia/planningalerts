...
ActiveRecord::Schema.define(version: 2019_01_21_015431) do
  ...
  create_table "geocode_queries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
